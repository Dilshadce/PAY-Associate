...
<html lang="en">
    <head>
        ...
        <script>
            var approveword = "Approve";
        </script>
        <cfif getHQstatus.ApproveVerify eq 'VERIFIED'>
            <script>
                approveword = "Verify";
            </script>
        </cfif>
        ...
        <script type="text/javascript">
                    ...
                    buttons: {
                        tryAgain: {
                            ...
                            action: function(){
                                ...
                                var theForm = document.getElementById('leaveForm');
                                ...
                                if (updateType == 'Mass')
                                {
                                    $('.checks:checked').each(function () {
                                        ...
                                        document.getElementById('remarks_'+this.value).value = document.getElementById('mgmtremarks-'+this.value).value;
                                    });
                                ...
                                {                                    
                                    ...
                                    +'&mgmtremarks='+document.getElementById('mgmtremarks-'+selectedid).value,'_self');
                                }
                            }
                        },
                        Cancel: function () {
            ...
            function advanceleavealert() {
                $.alert({
                    title: 'ADVANCE LEAVE ALERT!',
                    content: 'The leave date/s the Associate had applied has not been earned. Please APPROVE or REJECT application as per your good judgement.',
                    type: 'orange',
                    theme: 'light',
                });
            }
            ...
            <div class="container">
                ...
                <div class="checkbox-orange">
                    <ul class="nav nav-tabs">
                        ...
                        <li><a data-toggle="tab" onclick="switchStatus('#verifiedlName#');">#verifiedlName#</a></li>
                    ...
                    <div class="tab-content">
                        <div id="home" class="tab-pane fade in active">
                            ...
                            <form action="LeaveApprovalProcess.cfm" id="leaveForm" method="post" target="_self">
