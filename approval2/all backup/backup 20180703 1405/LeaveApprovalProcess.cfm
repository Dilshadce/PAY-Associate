    ...
    <cfloop list="#form.checkerlist#" delimiters="," index="a">
        ...
        <cfif "#form.tsstatus#" EQ "Approve">
            ...
            <cfif "#Val(leavebalance)#" GTE 0>
                ...
                <cfset alertlist = "#ListAppend(alertlist, '#getleave.empname# leave(#getleave.leavetype#) on #DateFormat(getleave.startdate, 'yyyy-mm-dd')# to #DateFormat(getleave.enddate, 'yyyy-mm-dd')# has been #timestatus#.', '|')#">
...
<cfelse>
    ...
    <cfif "#url.statusUpdate#" EQ "Approve">
        ...
        <cfelseif "#getleave.leavetype#" EQ "NPL">
            <cfset leavebalance = 999>
        <cfelse>
            <cfset leavebalance = #Val(Evaluate('#getleave.leavetype#days'))# - #Val(getusedleave.taken)#>
        </cfif>
