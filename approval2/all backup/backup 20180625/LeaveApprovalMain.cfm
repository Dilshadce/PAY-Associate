                    ...
                    <div class="tab-content">
                        <div id="home" class="tab-pane fade in active">
                            ...
                            <div class="alert alert-info">
                                ...
                                <ul>
                                    <li>
                                        Select asssociate that you would like to mass approve/reject by clicking on 
                                    ...
                                    <li>
                                        ...
                                        and you may choose to <strong>approve/reject</strong>. Alternately, you can use the <strong>"Check all"</strong> button.
                                    </li>
                                    <li>
                                        Approval: You can approve <strong>with or without</strong> remarks.
                                    </li>
                                    <li>
                                        Reject: You <strong>must</strong> input remarks to reject.
                                    </li>
                                    <li>
                                        Alternately, you can also <strong>approve/reject</strong> individual timesheet by clicking on 
