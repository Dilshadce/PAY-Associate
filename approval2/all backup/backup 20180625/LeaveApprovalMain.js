	...
	var resultTable=$('#resultTable')
		.dataTable({
			...
			'aoColumnDefs':[
                ...
                {'aTargets':[1],'sTitle':'NO'.toUpperCase(),'mData':'placementno','bSortable':false,'sWidth':'6%',
				...
				{'aTargets':[4],'sTitle':'DATE START','mData':'startdate','bSortable':true,'sWidth':'14%'},
				{'aTargets':[5],'sTitle':'DATE END','mData':'enddate','bSortable':true,'sWidth':'14%'},
				{'aTargets':[6],'sTitle':'DAYS','mData':'days','bSortable':true,'sWidth':'11%'},
				...
				{'aTargets':[9],'sTitle':'TIME TO','mData':'endampm','bSortable':true,'sWidth':'9%'},
				{'aTargets':[10],'sTitle':'ATTACHMENT','mData':'placementno','bSortable':false,'sWidth':'16%',
				'mRender':function(data,type,full){
						if(full.signdoc != ''){
				...
				{'aTargets':[11],'sTitle':'REMARKS','mData':'remarks','bSortable':false,'sWidth':'15%'},
				{'aTargets':[12],'sTitle':'ACTION','mData':'placementno','bSortable':false,'bVisible':true,'sWidth':'26%',				
					'mRender': function(data,type,full){
						if(tstatus == 'Submitted For Approval') {
                            return '<span class="glyphicon glyphicon-ok btn btn-link" title="Approve" '+
									'onclick="remarksinput(\'Approve\', \'Single\', \''+full.id+'\')">&nbsp;Approve</span>'
