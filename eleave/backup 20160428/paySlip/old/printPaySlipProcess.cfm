...
<cfif isdefined("form.paytype") and form.paytype eq "pay1_12m_fig">
	<cfset paytype = "1st half -">
<cfelseif isdefined("form.paytype") and form.paytype eq "pay2_12m_fig">
	<cfset paytype = "2nd half -">
<cfelseif isdefined("form.paytype") and form.paytype eq "pay_12m">
	<cfset paytype = "">
</cfif>
...
SELECT * FROM #form.paytype# WHERE TMONTH=#month_value# and empno="#emp_data.empno#"
</cfquery>
...
<cfloop query="selectList">
		...
		<cfquery name="select_data" datasource="#DSNAME#">
		SELECT * FROM #form.paytype# AS pt LEFT JOIN pmast AS pm ON pt.empno = pm.empno WHERE TMONTH=#form.month1# and pt.empno="#selectList.empno#"
		</cfquery>
	...
	<table width="1000px" border="0">
		...
		<th align="center">#paytype# #DATEFORMAT(date,'MMMM YYYY')#</th>
		<th align="right">
			<cfinvoke component="cfc.data_represent" method="paytype" pay="#emp_data.payrtype#" returnvariable="pay_type" />
			#pay_type#&nbsp;/&nbsp;
			<cfinvoke component="cfc.data_represent" method="paymeth" pay_method="#emp_data.paymeth#" returnvariable="pay_meth" />
			#pay_meth#
		</th>
		</tr>
		<tr>
...
<td width="50px"><cfif company_details.ccode eq 'MY'>EPF<cfelse>CPF</cfif>
</td>
<cfif company_details.ccode eq 'MY'><td width="50px">SOCSO</td></cfif>
<td width="90px">&nbsp;</td>
...
<cfif company_details.ccode  eq 'MY'><td>#numberformat(select_data.socsoww,'.__')#</td></cfif>
<td width="90px">&nbsp;</td>
<td width="90px">#numberformat(select_data.netpay,'.__')#</td>
<td width="10px"></td>
<cfif company_details.t20 eq "1"><td width="180px">EMPLOYEE's SIGNATURE</td></cfif> 
</tr>
</table>
</td >
</tr>
