...
<cfset endno = mid(trim(getplacementlist.timesheet),4,2)>
        ...
        <tr>
        <td colspan="6"><h1>Online timesheet is not applicable at this moment.  Please contact Business Edge at 6745-4288 during office hour (9am to 6pm) if you have further queries.</h1></td>
        </tr>
		</cfif>
        </table>
