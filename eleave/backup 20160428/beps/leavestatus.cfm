...
<cfabort>
      ...
      AND status = 'Submitted For Approval' or status = 'approved' or status = 'Submitted For Approval 2'
      GROUP BY leavetype
      </cfquery>
...
<!---             <cfoutput>
      ...
      WHERE status = 'Submitted For Approval' or status = 'approved' or status = 'Submitted For Approval 2'
