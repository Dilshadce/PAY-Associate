...
<script src="/javascripts/CalendarControl.js" language="javascript"></script>
 ...
 <cfquery name="company_details" datasource="payroll_main">
        ...
        SELECT * FROM iccolorid  WHERE colorid = "#getplacementlist.timesheet#"
        </cfquery>
...
<cfset endno = mid(trim(getplacementlist.timesheet),4,2)>
        ...
        SELECT * FROM #replace(dts,'_i','_a')#.arcust WHERE custno = "#getplacementlist.custno#"
        </cfquery>
...
<table border=0 cellpadding=0 cellspacing=0 width=800 style='border-collapse:
 ...
 <tr height=20 style='height:15.0pt'>
  <td colspan=2 rowspan=3 height=60 class=xl1188828 style='border-right:.5pt solid black;
  border-bottom:.5pt solid black;height:45.0pt'>Client</td>
 ...
 <tr height=21 style='mso-height-source:userset;height:15.75pt'>
  <td colspan=2 rowspan=2 height=41 class=xl1188828 style='border-right:.5pt solid black;
  border-bottom:.5pt solid black;height:30.75pt'>Staff</td>
  <td colspan=6 class=xl1248828 width=320 style='border-right:.5pt solid black;
  border-left:none;width:240pt'>Name</td>
  <td colspan=2 class=xl1248828 width=128 style='border-right:.5pt solid black;
 ...
 <cfquery name="gettimesheet" datasource="#dsname#">
    SELECT * FROM timesheet WHERE empno = "#emp_data.empno#" and tmonth = "#company_details.mmonth#" ORDER BY tsrowcount
    </cfquery>
 <tr height=20 style='height:15.0pt'>
  <td colspan=6 height=20 class=xl1258828 style='border-right:.5pt solid black;
...
(Full Day/AM/PM)</td>
 ...
 <tr height=32 style='height:24.0pt'>
  ...
  <td colspan=2 class=xl1058828 width=128 style='border-right:.5pt solid black;
 ...
 <tr height=20 style='height:15.0pt'>
  <td colspan=11 height=20 class=xl1298828 style='border-right:.5pt solid black;
...
hol_date = "#dateformat(currentdate,'yyyy-mm-dd')#"
 ...
 <tr height=20 style='height:15.0pt'>
  <td colspan=8 height=20 class=xl1158828 width=448 style='border-right:.5pt solid black;
 ...
 <tr height=20 style='height:15.0pt'>
  <td colspan=13 rowspan=2 height=40 class=xl658828 width=735 style='border-right:
  .5pt solid black;border-bottom:.5pt solid black;height:30.0pt;width:552pt'>Please
