<cfif #url.action# EQ "create">
    ...
    <cfquery name="insertEmail" datasource="#dts#">
    ...
    <cfif #form.scheduleTime# NEQ "">
        <cfschedule action = "update"
                    task = "#dts#_sendBodMsg_id=#getEmail.id#"
                    operation = "HTTPRequest"
                    url = "http://crm.netiquette.asia/bodAutoSend.cfm?dts=#dts#&cate=Email&id=#getEmail.id#&userid=#Huserid#&userloc=#Huserloc#"
...
<cfelseif #url.action# EQ "edit">
	...
	<cfquery name="updateEmail" datasource="#dts#">
    	UPDATE smsemail
    ...
    <cfif #schedule# NEQ " ">
    	<cfif #getEmail.type# EQ "Birthday">
            <cfschedule action = "update"
                        task = "#dts#_sendBodMsg_id=#url.id#"
                        operation = "HTTPRequest"
                        url = "http://crm.netiquette.asia/bodAutoSend.cfm?dts=#dts#&cate=Email&id=#url.id#&userid=#Huserid#&userloc=#Huserloc#"
                        startDate = "#dateformat(now(),'YYYY-MM-DD')#"
                        startTime = "#form.scheduleTime#"
                        interval = "daily"
                        resolveURL = "Yes"
