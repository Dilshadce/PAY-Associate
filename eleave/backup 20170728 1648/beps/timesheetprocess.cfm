...
<cfif isdefined('form.updatefile') or gettimesheet.recordcount neq 0>
...
and tmonth = "#company_details.mmonth#"
and tsrowcount = "#i#"
</cfquery>
</cfloop>
...
<table border=0 cellpadding=0 cellspacing=0 width=735 style='border-collapse:
 ...
 <tr>
 <td colspan="9" class=xl1138828 style="text-align:left">Business Edge Personnel Services Pte Ltd</td>
 <td colspan="4" class=xl1138828 style="text-align:right;font-size:12px">Co Reg No. 199606466D</td>
 </tr>
...
<tr height=20 style='height:15.0pt'>
 ...
 <!---  <td height=20 class=xl1188828 style='border-right:1pt solid black;
  ...
  <cfquery name="getleavegroup" datasource="#dsname#">
    SELECT stcol,sum(workhours) as totalwh FROM timesheet WHERE empno = <cfqueryparam cfsqltype="cf_sql_varchar" value="#getplacementlist.empno#"> and tmonth = <cfqueryparam cfsqltype="cf_sql_varchar" value="#company_details.mmonth#"> and stcol <> "" and stcol is not null GROUP BY stcol ORDER BY tsrowcount
    </cfquery>
  ...
  <cfquery name="getall" datasource="#dsname#">
    SELECT sum(workhours) as wh FROM timesheet WHERE empno = <cfqueryparam cfsqltype="cf_sql_varchar" value="#getplacementlist.empno#"> and tmonth = <cfqueryparam cfsqltype="cf_sql_varchar" value="#company_details.mmonth#"> AND (stcol = "" or stcol is null)
    </cfquery>
    
    <cfquery name="getot" datasource="#dsname#">
    SELECT sum(othour) as oth FROM timesheet WHERE empno = <cfqueryparam cfsqltype="cf_sql_varchar" value="#getplacementlist.empno#"> and tmonth = <cfqueryparam cfsqltype="cf_sql_varchar" value="#company_details.mmonth#">
    </cfquery>
    
    <cfquery name="getalldays" datasource="#dsname#">
    SELECT * FROM timesheet WHERE empno = <cfqueryparam cfsqltype="cf_sql_varchar" value="#getplacementlist.empno#"> and tmonth = <cfqueryparam cfsqltype="cf_sql_varchar" value="#company_details.mmonth#">
    </cfquery>
 ...
 <cfset leavenonworkday = "">
    ...
    SELECT * FROM timesheet WHERE empno = <cfqueryparam cfsqltype="cf_sql_varchar" value="#getplacementlist.empno#"> and tmonth = <cfqueryparam cfsqltype="cf_sql_varchar" value="#company_details.mmonth#"> and editable = "Y" and stcol = <cfqueryparam cfsqltype="cf_sql_varchar" value="#getleavegroup.stcol#"> ORDER BY tsrowcount
    </cfquery>
    <cfset startcount = 0 >
 ...
 <tr height=20 style='height:12.0pt'>
  ...
  email / fax completed &amp; stamped timesheet with all supporting documents to &quot;timesheet@businessedge.com.sg&quot; / fax ## 6745-8955<br>
