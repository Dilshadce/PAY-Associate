...
<body>
	<div class="tabber">
        ...
        <td><span id="sprytextfield2">
          <cfinput type="password" name="password" id="password" validate="regex" pattern="^(?=.*[a-zA-Z])(?=.*[0-9])" message="Must be alphanumeric!" />
        ...
        <td>
          <span id="sprytextfield3">
            <cfinput type="password" name="cpassword" id="cpassword" />
