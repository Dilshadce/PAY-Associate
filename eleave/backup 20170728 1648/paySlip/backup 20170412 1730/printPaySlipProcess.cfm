<cfquery datasource="manpower_p" name="getEmp">
	SELECT empno,
	(SELECT nricn FROM manpower_p.pmast where empno = emp_users.empno) as nric FROM emp_users where userName = '#getAuthUser()#'
</cfquery>
...
<cfquery name="getEntity" datasource="#dts#">
	...
	<cfreport template="payslip.cfr" filename="#getEmp.empno#_payslip.pdf"  format="PDF" 
permissions="AllowPrinting" 
userpassword="#getEmp.nric#"
	overwrite="yes"
	encryption="128-bit"
	>
...
<cfoutput>C:/NewSystem/PAY-Associate/eleave/paySlip/#getEmp.empno#_payslip.pdf</cfoutput>
