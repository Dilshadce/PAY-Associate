...
<table>
    ...
    <tr>
        <th>Claim Amount</th>
        <td><cfinput type="text" id="claimamounttxt" name="claimamounttxt" size="10" required="yes" validate="range" validateat="onsubmit" maxlength="10" value="#claimamount#">
<!---			<cfif checkdefault.amountperclaim gt 0>
    ...
    <tr>
        <th>Remarks</th>
       		<td >
            	<cfinput type="text" name="remarksinput" id="remarksinput" value="#remarks#"  size="38%" maxlength="50" required="yes" message="Remarks is required">
            </td>
    </tr>	
