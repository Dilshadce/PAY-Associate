...
<table>
    ...
    <tr>
        <th>Contract Cap</th>
        	<td>#evaluate('getempno.total#form.postid#claimable')#</td>
    </tr>
    <tr>
        <th>Per Visit Cap</th>
        	<td>#evaluate('getempno.per#form.postid#claimcap')#</td>
    </tr>
	
    <tr>
        <th>Claim Amount</th>
        <td><cfinput type="text" id="claimamounttxt" name="claimamounttxt" size="10" required="yes" validate="float" validateat="onsubmit" maxlength="10" message="Claim Amount is Invalid / Required!" >
