...
<cfoutput>
	...
	<p id="calendarcontrols">
		&laquo;
		<a href="index.cfm?action=month&amp;date=#Fix( dtPrevMonth )#">#DateFormat( dtPrevMonth, "mmmm yyyy" )#</a> &nbsp;|&nbsp;
		<a href="index.cfm?action=month&amp;date=#Fix( dtNextMonth )#">#DateFormat( dtNextMonth, "mmmm yyyy" )#</a>
		&raquo;
	</p>
