...
<cfif #channel# NEQ 'email'>
  ...
  <cfloop query="getAssignment">
	...
	<cfquery name="InsertTempPayslip" datasource="manpowertest_p">
        ...
        <cfqueryparam cfsqltype="CF_SQL_DECIMAL" value="#params.totalearnings#">,
        <cfqueryparam cfsqltype="CF_SQL_DECIMAL" value="#params.totaldeductions#">,
        <cfqueryparam cfsqltype="CF_SQL_DECIMAL" value="#params.nett#">,
        <cfqueryparam cfsqltype="CF_SQL_DECIMAL" value="#params.epfcc#">,
        <cfqueryparam cfsqltype="CF_SQL_DECIMAL" value="#params.socsocc#">,
        <cfqueryparam cfsqltype="CF_SQL_DECIMAL" value="#params.ytdnett#">,
        <cfqueryparam cfsqltype="CF_SQL_DECIMAL" value="#params.ytdgross#">,
        <cfqueryparam cfsqltype="CF_SQL_DECIMAL" value="#params.ytdepfcc#">,
        <cfqueryparam cfsqltype="CF_SQL_DECIMAL" value="#params.ytdepfww#">,
        <cfqueryparam cfsqltype="CF_SQL_DECIMAL" value="#params.ytdsocsocc#">,
        <cfqueryparam cfsqltype="CF_SQL_DECIMAL" value="#params.ytdsocsoww#">,
        <cfqueryparam cfsqltype="CF_SQL_DECIMAL" value="#params.ytdtax#">
        );        
...
<!---</cfloop>--->
    ...
    <cfreport template="payslip2.cfr" permissions="allowprinting" 
