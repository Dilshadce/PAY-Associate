  ...
  <cfloop query="getAssignment">
    ...
    <cfscript>
        ...
        if(getPayYTD.EISWW == ""){
		 ...
		 nettPay = #val(getAssignment.sum_selftotal)# - #val(getAssignment.DED115)# - #val(getAssignment.DED114)# - #val(getAssignment.DED109)#; /*Added 20170801 1600, Nieo*/
    ...
    <cfif #printtype# EQ "PDF">                                            <!---For generate payslip in PDF--->
        ...
        <cfelse>
            <cfif #getEmp.nricn# neq "">
                <cfset payslippassword = "#Trim(getEmp.nricn)#">
            <cfelseif #getEmp.passport# neq "">
                <cfset payslippassword = "#Trim(getEmp.passport)#">
            <cfelse>
...
<cffunction name="sendMail" access="remote" > <!---remote, returnFormat="json"--->
    ...
    <cftry>
    	...
    	<cfif year eq '2017'>
            <cfmail from="donotreply@manpower.com.my" to="#trim(empPmast.email_address)#" failto="mymppayroll@manpower.com.my" bcc="alvin.hen@manpower.com.my,jiexiang.nieo@manpower.com.my" subject="Revised: E-Payslip #MonthAsString(month)# #year#" type="HTML">
                <p>Dear Associate, </p>
                <br>
