    ...
    <cfscript>
        ...
        if(getAssignment.sum_selfEIS > 0 ){
		 ...
		 if(getAssignment.sum_lvltotalee1 != 0 and getAssignment.sum_lvltotalee1 != ''){
		 	...
		 	ArrayAppend(deductions_amt , NumberFormat(getAssignment.sum_lvltotalee1 * -1, '.__'));
		 }
...
<!---</cfloop>--->
    ...
    <cfif #printtype# EQ "PDF">                                            <!---For generate payslip in PDF--->
        ...
        <cfelse>
            ...
            <cfelse>
                <cfreport template="payslip.cfr" permissions="allowprinting"filename="Generated_payslip\#getEmp.empno#_#MonthAsString(monthselected)##yearselected#_payslip.pdf" format="PDF" userpassword="#payslippassword#"
                overwrite="yes"	encryption="128-bit" query="getTempPayslip" >
                  <!---<cfloop collection="#params#" item="field">
                    <cfreportparam name="#field#" value="#params[field]#">
                  </cfloop>--->
