...
<!---dsname is _p--->
    ...
    <cfquery name="checkPay" datasource="#dts#">
        ...
        SELECT a.empno, a.batches, b.appstatus, b.girorefno
        FROM assignmentslip a
        LEFT JOIN argiro b ON a.batches = b.batchno
        WHERE a.empno = "#getEmpno.empno#"
        AND a.payrollperiod = "#form.month#"
    ...
    <cfif #checkPay.recordcount# NEQ 0 AND "#checkPay.girorefno#" NEQ ""> <!---#DateFormat(now(), 'yyyy-mm-dd')# GTE #DateFormat(checkPay.avail_date, 'yyyy-mm-dd')#--->
