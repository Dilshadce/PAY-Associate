...
--->
  ...
  <cfquery name="getAssignment" datasource="#dsname#">
	...
	<!---CASE WHEN aa.paydate = "paytran" then--->
		ifnull((SELECT CASE WHEN SUM(coalesce(b.ded115,0.00)+coalesce(bb.ded115,0.00)+coalesce(b.DED113,0.00)+coalesce(bb.DED113,0.00)) is null then 0 
  ...
  <cfloop query="getAssignment">
    ...
    <cfscript>
        ...
        if(getPayYTD.EISWW == ""){
		 ...
		 nettPay = #val(getAssignment.sum_selftotal)# - #val(getAssignment.DED115)# - #val(getAssignment.DED114)# - #val(getAssignment.DED109)#- #val(taxrefund)#; /*Added 20170801 1600, Nieo*/
