...
<cffunction name="sendMail" access="remote" > <!---remote, returnFormat="json"--->
    ...
    <cftry>
    	<cfmail from="donotreply@manpower.com.my" to="#trim(empPmast.email_address)#" failto="alvin.hen@manpower.com.my" bcc="alvinh.mpg@gmail.com" subject="E-Payslip #MonthAsString(month)# #year#" type="HTML">
			<p>Dear Associate, </p>
			<br>
