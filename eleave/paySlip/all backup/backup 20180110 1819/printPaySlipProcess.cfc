...
<cffunction name="generatePayslip" access="public">
  ...
  <cfargument name="tools" type="any" required="no">
  <cfargument name="toolstype" type="any" required="no">
  <cfargument name="hrootpath" type="any" required="no">
  <cfargument name="huserid" type="any" required="no">
...
--->
  ...
  <cfquery name="getAssignment" datasource="#dsname#">
	...
	WHERE batches != ''
	AND payrollperiod = "#monthselected#"
	AND year(assignmentslipdate) = "#company_details.myear#"
	AND aa.empno = "#getEmp.empno#"
    <!---<cfif dsname eq control>--->
        AND aa.refno in
        (
            SELECT a.invoiceno from #dts#.icgiro a
...
<!---</cfloop>--->
    ...
    <cfelse>                                                                <!---For generate payslip in txt--->
        ...
        <cfscript>
            ...
            leftVal = [ numberformat(params.epfcc,'9.99'),numberformat(params.socsocc,'9.99'),params.bank];
            ...
            numberformat(tnettPay,'9.99'),y_epf,y_socso,tax];
            leftLabelStart = 10;
            leftComma = 24;
