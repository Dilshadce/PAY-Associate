...
<cfif mstaff eq "N">
    ...
    <cfquery name="insert_application" datasource="#DSNAME#">
        INSERT INTO leave_apl (empno,DateStart,DateEnd,days,leave_type,leave_option,status,applydate,timeFr,timeTo,applicant_remarks) 
        VALUES (
    ...
    <script type="text/javascript">
        location.href="/Eleave/leave/leaveApplicationStatus.cfm";
    </script>
</cfif>
</cfoutput>