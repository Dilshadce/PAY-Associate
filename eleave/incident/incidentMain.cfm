...
<cfform action="/eleave/incident/incidentprocess.cfm" method="post" name="eForm" id="eform" enctype="multipart/form-data" onsubmit="return confirm('Are You Sure You Want To Submit Incident Log?')">
    <table>
        <tr>
            ...
            <td>#getEmp.placementno#<input type="hidden" id="pno" name="pno" value="#getEmp.placementno#" readonly></td>
        </tr>
        <tr>
		    <th>Employee</th>
        	<td>
            	#getEmp.empno# - #getemp.empname#<input type="hidden" id="empno" name="empno" value="#getEmp.empno#" readonly>
            </td>
        </tr>
        <tr>
        <th>Company</th>
