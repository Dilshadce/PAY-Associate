...
$(document).ready(function(){
    ...
    <cfif (#form.nexmonth# LT '7' OR #form.nexmonth# GT '9') AND ("#year(DateFormat(getplacementlist.completedate, 'yyyy-mm-dd'))#" NEQ "#year(now())#" AND "#month(DateFormat(getplacementlist.completedate, 'yyyy-mm-dd'))#" NEQ "#month(now())#")>
        if(document.getElementById('custno').value == document.getElementById('exceptioncustno').value){
