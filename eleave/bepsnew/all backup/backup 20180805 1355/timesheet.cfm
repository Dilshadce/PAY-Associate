...
<cfoutput>
    ...
    <cfif "#getblockid.recordcount#" NEQ 0 AND "#getblockid.save_submit_block#" EQ "Y">
        <cfset blockss = "#Evaluate('getblockid.month#form.nexmonth#')#">
    <cfelse>
        <cfset blockss = "N">  
    </cfif>
    ...
    <input type="hidden" id="ssblock" value="#blockss#">
</cfoutput>
...
<head>
    <script type="text/javascript">
        ...
        $(document).ready(function(){
            ...
            if(document.getElementById('ssblock').value == 'Y'){
                $('##save').prop('disabled', true);
                $('##sub_btn').prop('disabled', true);
            }
            <!---Added enable timesheet for 2 months ahead if end of contract reached--->
        });
            ...
            <table border=0 cellpadding=0 cellspacing=0 width=735 style='border-collapse:collapse;table-layout:fixed;width:800pt'>
                ...
                <cfloop from="0" to="#nonscount#" index="i">
                    ...
                    <cfif #GetSpecificTime.recordcount# neq 0> <!---if data found for that specific date, replace it instead of using default value--->
                        ...
                        <tr onMouseOut="javascript:this.style.backgroundColor='';" onMouseOver="javascript:this.style.backgroundColor='f3bd90';" height=20 
                            ...
                            <td class=xl768828 style='border-top:none;border-left:none'>
                                <select class="inputTime" name="ottype#i#" id="ottype#i#" onChange="makehour('#i#');" style="width: 80px;">
                                    <cfloop query="ot_calc">
                ...
                <tr>
                    <td class=xl158828 align="center" colspan="18">
                        <input type="button" name="save" id="save" onClick="<cfif (#submittedStatus# eq True) OR (#editableStatus# eq TRUE)>alert('Timesheet Has Been Submitted, No Update is Allowed')
