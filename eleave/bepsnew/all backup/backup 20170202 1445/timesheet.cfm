...
(Full Day/AM/PM)</td>
 ...
 <!---when no data this will be executed---> <!---no timesheet found in database, create a template for user--->
        ...
        <cfloop from="0" to="#nonscount#" index="i">
            ...
            <cfif #GetSpecificTime.recordcount# neq 0> <!---if data found for that specific date, replace it instead of using default value--->
                ...
                <tr  onMouseOut="javascript:this.style.backgroundColor='';" onMouseOver="javascript:this.style.backgroundColor='f3bd90';" height=20 style='height:15.0pt'>
                    ...
                    <td class=xl798828 width=36 style='border-top:none;border-left:none; width:26pt'><input type="text" name="ot#i#" id="ot#i#" value="#numberformat(GetSpecificTime.othour,'.__')#" size="4" onKeyUp="ottotal();" style="width:40px" ></td>
