...
<table border=0 cellpadding=0 cellspacing=0 width=800 style='border-collapse:
 ...
 <col width=68 span=2 style='width:65pt'>
  ...
  <col width=32 span=8 style='width:24pt'>
...
(Full Day/AM/PM)</td>
  ...
  <td class=xl878828 width=32 style='border-top:none;width:24pt'>OT 1</td>
  <td class=xl878828 width=32 style='border-top:none;width:24pt'>OT 1.5</td>
  <td class=xl878828 width=32 style='border-top:none;width:24pt'>OT 2</td>
  <td class=xl878828 width=32 style='border-top:none;width:24pt'>OT 3</td>
 ...
 <tr height=32 style='height:24.0pt'>
  ...
  <td class=xl858828 width=32 style='border-top:none;border-left:none;
  width:24pt'>Hour</td>
  <td class=xl858828 width=32 style='border-top:none;border-left:none;
  width:24pt'>Hour</td>
  <td class=xl858828 width=32 style='border-top:none;border-left:none;
...
<td class=xl768828 style='border-top:none;border-left:none'>
 ...
 <!---  <select name="timeoff#gettimesheet.tsrowcount#" id="timeoff#gettimesheet.tsrowcount#" onChange="workhour('#gettimesheet.tsrowcount#');">
  ...
  <td class=xl798828 width=32 style='border-top:none;border-left:none;
  width:24pt'><input type="text" name="ot#gettimesheet.tsrowcount#" id="ot#gettimesheet.tsrowcount#" value="#numberformat(gettimesheet.othour,'.__')#" size="3" onKeyUp="ottotal();" ></td>
  <td class=xl798828 width=32 style='border-top:none;border-left:none;
  width:24pt'><input type="text" name="ot#gettimesheet.tsrowcount#" id="ot#gettimesheet.tsrowcount#" value="#numberformat(gettimesheet.othour,'.__')#" size="3" onKeyUp="ottotal();" ></td>
  <td class=xl798828 width=32 style='border-top:none;border-left:none;
  width:24pt'><input type="text" name="ot#gettimesheet.tsrowcount#" id="ot#gettimesheet.tsrowcount#" value="#numberformat(gettimesheet.othour,'.__')#" size="3" onKeyUp="ottotal();" ></td>
  ...
  <td class=xl758828 style='border-top:none;border-left:none'>
    <input type="text" name="remarks#gettimesheet.tsrowcount#" id="remarks#gettimesheet.tsrowcount#" value="#gettimesheet.remarks#" maxlength="40"></td>
  <td class=xl158828></td>
  <td class=xl158828></td>
 </tr>
...
<td class=xl768828 style='border-top:none;border-left:none'>
  ...
  <td class=xl798828 width=32 style='border-top:none;border-left:none;
  width:24pt'><input type="text" name="ot#i#" id="ot#i#" value="0.00" size="3"  onKeyUp="ottotal();"></td>
  <td class=xl798828 width=32 style='border-top:none;border-left:none;
  width:24pt'><input type="text" name="ot#i#" id="ot#i#" value="0.00" size="3"  onKeyUp="ottotal();"></td>
  <td class=xl798828 width=32 style='border-top:none;border-left:none;
  width:24pt'><input type="text" name="ot#i#" id="ot#i#" value="0.00" size="3"  onKeyUp="ottotal();"></td>
...
hol_date = "#dateformat(currentdate,'yyyy-mm-dd')#"
 ...
 <tr height=20 style='height:15.0pt'>
  ...
  <td class=xl808828 width=32 style='border-top:none;border-left:none;
  width:24pt'><input type="text" name="totalhour" id="totalhour" value="#numberformat(totalhour,'.__')#" size="4" ></td>
  <td class=xl808828 width=32 style='border-top:none;border-left:none;
  width:24pt'><input type="text" name="totalot" id="totalot" value="#numberformat(totalot,'.__')#" size="3" ></td>
  <td class=xl808828 width=32 style='border-top:none;border-left:none;
  width:24pt'><input type="text" name="totalot" id="totalot" value="#numberformat(totalot,'.__')#" size="3" ></td>
  <td class=xl808828 width=32 style='border-top:none;border-left:none;
  width:24pt'><input type="text" name="totalot" id="totalot" value="#numberformat(totalot,'.__')#" size="3" ></td>
...
<!---  <tr height=20 style='height:15.0pt'>
 ...
 <tr height=20 style='height:15.0pt'>
  <td colspan=20 rowspan=2 height=40 class=xl658828 width=735 style='border-right:1pt solid black;border-bottom:1pt solid black;height:30.0pt;width:552pt'>#gettimesheetdetail.term#</td>
 </tr>
 <tr height=20 style='height:15.0pt'>
 </tr>
 <tr height=20 style='height:15.0pt'>
  <td class=xl158828 align="center" colspan="20"><input type="button" name="save" id="save" onClick="
