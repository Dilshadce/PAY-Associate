...
$(document).ready(function(){
    ...
    <cfif (#form.nexmonth# LT '11' OR #form.nexmonth# GTE '13') AND (DateCompare('#DateFormat("2018-07-02", "yyyy-mm-dd")#', '#DateFormat(getplacementlist.completedate, "yyyy-mm-dd")#', 'm') NEQ 0)>
        if(document.getElementById('custno').value == document.getElementById('exceptioncustno').value){
