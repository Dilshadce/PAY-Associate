...
<table border=0 cellpadding=0 cellspacing=0 width=800 style='border-collapse:
 ...
 <tr height=26 style='height:19.5pt'>
  <td colspan=20 class=xl1138828 width=669 style='width:502pt'>MONTHLY TIMESHEET</td>
 </tr>
...
(Full Day/AM/PM)</td>
 ...
 <tr height=20 style='height:15.0pt'>
  <td colspan=18 height=20 class=xl1298828 style='border-right:1pt solid black;
...
<td class=xl768828 style='border-top:none;border-left:none'>
 ...
 <!---  <select name="timeoff#gettimesheet.tsrowcount#" id="timeoff#gettimesheet.tsrowcount#" onChange="workhour('#gettimesheet.tsrowcount#');">
  ...
  <td class=xl798828 width=36 style='border-top:none;border-left:none; width:26pt'><input type="text" name="ot#gettimesheet.tsrowcount#" id="ot#gettimesheet.tsrowcount#" value="#numberformat(gettimesheet.othour,'.__')#" size="3" onKeyUp="ottotal();" style="width:32px" ></td>
  <td class=xl798828 width=36 style='border-top:none;border-left:none; width:26pt'><input type="text" name="ot15#gettimesheet.tsrowcount#" id="ot15#gettimesheet.tsrowcount#" value="#numberformat(gettimesheet.ot15hour,'.__')#" size="3" onKeyUp="ot15total();" style="width:32px" ></td>
  <td class=xl798828 width=36 style='border-top:none;border-left:none; width:26pt'><input type="text" name="ot20#gettimesheet.tsrowcount#" id="ot20#gettimesheet.tsrowcount#" value="#numberformat(gettimesheet.ot2hour,'.__')#" size="3" onKeyUp="ot2total();" style="width:32px" ></td>
  <td class=xl798828 width=36 style='border-top:none;border-left:none; width:26pt'><input type="text" name="ot30#gettimesheet.tsrowcount#" id="ot30#gettimesheet.tsrowcount#" value="#numberformat(gettimesheet.ot3hour,'.__')#" size="3" onKeyUp="ot3total();" style="width:32px" ></td>
  <td class=xl798828 width=36 style='border-top:none;border-left:none; width:26pt'><input type="text" name="otrd1#gettimesheet.tsrowcount#" id="otrd1#gettimesheet.tsrowcount#" value="#numberformat(gettimesheet.otrd1hour,'.__')#" size="3" onKeyUp="otrd1total();" style="width:32px" ></td>
  <td class=xl798828 width=36 style='border-top:none;border-left:none; width:26pt'><input type="text" name="otrd2#gettimesheet.tsrowcount#" id="otrd2#gettimesheet.tsrowcount#" value="#numberformat(gettimesheet.otrd2hour,'.__')#" size="3" onKeyUp="otrd2total();" style="width:32px" ></td>
  <td class=xl798828 width=36 style='border-top:none;border-left:none; width:26pt'><input type="text" name="otph1#gettimesheet.tsrowcount#" id="otph1#gettimesheet.tsrowcount#" value="#numberformat(gettimesheet.otph1hour,'.__')#" size="3" onKeyUp="otph1total();" style="width:32px" ></td>
  <td class=xl798828 width=36 style='border-top:none;border-left:none; width:26pt'><input type="text" name="otph2#gettimesheet.tsrowcount#" id="otph2#gettimesheet.tsrowcount#" value="#numberformat(gettimesheet.otph2hour,'.__')#" size="3" onKeyUp="otph2total();" style="width:32px" ></td>
  ...
  <td class=xl758828 style='border-top:none;border-left:none'>
    <input type="text" name="remarks#gettimesheet.tsrowcount#" id="remarks#gettimesheet.tsrowcount#" value="#gettimesheet.remarks#" size="15" maxlength="40"></td>
  <td class=xl158828></td>
  <td class=xl158828></td>
 </tr>
...
<td class=xl768828 style='border-top:none;border-left:none'>
  ...
  <td class=xl778828 width=64 style='border-top:none;border-left:none;
  width:65pt' nowrap><cfset hre = listfirst(evaluate('getplacementdetail.to#DayOfWeek(currentdate)#'),':')>
  ...
  <td class=xl798828 width=36 style='border-top:none;border-left:none; width:26pt'><input type="text" name="ot#i#" id="ot#i#" value="0.00" size="2"  onKeyUp="ottotal();" style="width:32px"></td>
  <td class=xl798828 width=36 style='border-top:none;border-left:none; width:26pt'><input type="text" name="ot15#i#" id="ot15#i#" value="0.00" size="3"  onKeyUp="ot15total();" style="width:32px"></td>
  <td class=xl798828 width=36 style='border-top:none;border-left:none; width:26pt'><input type="text" name="ot20#i#" id="ot20#i#" value="0.00" size="3"  onKeyUp="ot2total();" style="width:32px"></td>
  <td class=xl798828 width=36 style='border-top:none;border-left:none; width:26pt'><input type="text" name="ot30#i#" id="ot30#i#" value="0.00" size="3"  onKeyUp="ot3total();" style="width:32px"></td>
  <td class=xl798828 width=36 style='border-top:none;border-left:none; width:26pt'><input type="text" name="otrd1#i#" id="otrd1#i#" value="0.00" size="3"  onKeyUp="otrd1total();" style="width:32px"></td>
  <td class=xl798828 width=36 style='border-top:none;border-left:none; width:26pt'><input type="text" name="otrd2#i#" id="otrd2#i#" value="0.00" size="3"  onKeyUp="otrd2total();" style="width:32px"></td>
  <td class=xl798828 width=36 style='border-top:none;border-left:none; width:26pt'><input type="text" name="otph1#i#" id="otph1#i#" value="0.00" size="3"  onKeyUp="otph1total();" style="width:32px"></td>
  <td class=xl798828 width=36 style='border-top:none;border-left:none; width:26pt'><input type="text" name="otph2#i#" id="otph2#i#" value="0.00" size="3"  onKeyUp="otph2total();" style="width:32px"></td>
  <cfif pholiday eq "1">
...
hol_date = "#dateformat(currentdate,'yyyy-mm-dd')#"
  ...
  <td class=xl758828 style='border-top:none;border-left:none'><input type="text" name="remarks#i#" id="remarks#i#" <cfif pholiday eq "1">value="#getholidaydesp.hol_desp#"</cfif> maxlength="40"  size="15"></td>
  <td class=xl158828></td>
  <td class=xl158828></td>
 </tr>
 ...
 <tr >
  <td colspan=8 height=20 class=xl1158828 width=448 style='border-right:1pt solid black;border-left:1pt solid black;
 '>Total hours<!---  for the period (exclude breaks) ---></td>
  ...
  <td class=xl808828 width=36 style='border-top:none;border-left:none; width:26pt'><input type="text" name="totalot" id="totalot" style="width:32px" value="#numberformat(totalot,'.__')#" size="3" ></td>
  <td class=xl808828 width=36 style='border-top:none;border-left:none; width:26pt'><input type="text" name="totalot15" id="totalot15" style="width:32px" value="#numberformat(totalot,'.__')#" size="3" ></td>
  <td class=xl808828 width=36 style='border-top:none;border-left:none; width:26pt'><input type="text" name="totalot2" id="totalot2" style="width:32px" value="#numberformat(totalot2,'.__')#" size="3" ></td>
  <td class=xl808828 width=36 style='border-top:none;border-left:none; width:26pt'><input type="text" name="totalot3" id="totalot3" style="width:32px" value="#numberformat(totalot3,'.__')#" size="3" ></td>
  <td class=xl808828 width=36 style='border-top:none;border-left:none; width:26pt'><input type="text" name="totalotrd1" id="totalotrd1" style="width:32px" value="#numberformat(totalotrd1,'.__')#" size="3" ></td>
  <td class=xl808828 width=36 style='border-top:none;border-left:none; width:26pt'><input type="text" name="totalotrd2" id="totalotrd2" style="width:32px" value="#numberformat(totalotrd2,'.__')#" size="3" ></td>
  <td class=xl808828 width=36 style='border-top:none;border-left:none; width:26pt'><input type="text" name="totalotph1" id="totalotph1" style="width:32px" value="#numberformat(totalotph1,'.__')#" size="3" ></td>
  <td class=xl808828 width=36 style='border-top:none;border-left:none; width:26pt'><input type="text" name="totalotph2" id="totalotph2" style="width:32px" value="#numberformat(totalotph2,'.__')#" size="3" ></td>
