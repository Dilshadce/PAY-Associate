...
$(document).ready(function(){
    ...
    <cfif (#form.nexmonth# LT '1' OR (#form.nexmonth# LT '12' AND #form.nexmonth# GT '1')) AND (DateCompare('#DateFormat("2018-07-02", "yyyy-mm-dd")#', '#DateFormat(getplacementlist.completedate, "yyyy-mm-dd")#', 'm') NEQ 0)>
        if(document.getElementById('custno').value == document.getElementById('exceptioncustno').value){
