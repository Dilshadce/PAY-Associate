...
<link href="/stylesheet/app.css" rel="stylesheet" type="text/css" >
    ...
    <!---<cfif "#emp_data.empno#" EQ "100133793">
        <cfset company_details.mmonth = 10>
    </cfif>--->
    ...
    <cfloop query="checkplacementlist">
        ...
        <cfloop condition="#loopDate# lte #controlDate#">
            ...
            <cfif (#month(loopdate)# LT #month(checkplacementlist.startdate)# AND #year(loopdate)# EQ #year(checkplacementlist.startdate)#) OR #year(loopdate)# LT #year(checkplacementlist.startdate)#>
                <cfset loopDate = #dateformat(dateadd('m', 1, loopDate), 'yyyy-mm-dd')#>											
