...
<cfquery name="getdatabase" datasource="#dsname#">
        INSERT INTO claimlist (claimid,claimname,claimdes,allowance,claimamount, 
        remarks,created_on,updatedon,created_by,status,receipt_no,doc_no
...
<cfelseif isdefined("form.sub_but") and form.sub_but eq "Submit For Approval">
    ...
    <cfif result.recordcount gt 0 and company_details.claimapproval neq "turnoff">
