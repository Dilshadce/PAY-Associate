...
<a href="createlist.cfm?type=mcreate"><strong>< Back</strong></a>
    ...
    <cfset pervisitcap = "#numberformat(evaluate('getempno.per#form.postid#claimcap'), '.__')#">
    <cfset contractcap = "#numberformat(evaluate('getempno.total#form.postid#claimable'), '.__')#">
