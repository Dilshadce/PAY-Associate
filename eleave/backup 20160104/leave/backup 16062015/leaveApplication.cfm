...
<script src="/javascripts/CalendarControl<cfif DSNAME eq 'uniq_p' or DSNAME eq 'maven_p' or DSNAME eq 'kjcpl_p' or DSNAME eq 'viva_p' or DSNAME eq 'mlpl_p'>el</cfif>.js" language="javascript"></script>
...
<div class="tabber">
        ...
        <tr>
          <th>Leave Type</th>
          <td>:</td>
          <td><select id="leaveType" name="leaveType" onchange="if(this.value == 'NCL'){show_row('time');} else {show_row('days');}" Onclick="changeTozero()">
