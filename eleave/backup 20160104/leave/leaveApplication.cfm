...
<cfquery name="comp_details" datasource="payroll_main">
	SELECT mon,tue,wed,thu,fri,sat,sun,ncltoal FROM gsetup2 WHERE comp_id = <cfqueryparam cfsqltype="cf_sql_varchar" value="#HcomID#">
</cfquery>
...
function validate_form(thisform)
	...
	<!--- 	var days = document.eForm.days.value;
		...
		totday = totday * 1;
		if (totday == "" && document.getElementById("leaveType").value != 'NCL')
		{
...
<div class="tabber">
        ...
        <form action="/eleave/leave/leaveApplicationProcess.cfm" method="post" name="eForm" id="eform" onSubmit="return validate_form(this);">
        ...
        <tr>
          <th>Leave Type</th>
          <td>:</td>
          <td><select id="leaveType" name="leaveType" onchange="if(this.value == 'NCL' || this.value == 'TO'){show_row('time');} else {show_row('days');}" Onclick="changeTozero()">
                    ...
                    <option id="TO" value="TO">Time Off</option>
					<cfelse>
