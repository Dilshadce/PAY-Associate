...
<div class="tabber">
        ...
        <th>Job Order No</th>
        <td>:</td>
        <td><input type="text" id="pno" name="pno" value="#form.pno#" size="40"></td>
        </tr>
        <tr>
        ...
        <tr>
          <th>Leave Type</th>
          <td>:</td>
          <td><select id="leaveType" name="leaveType" Onclick="changeTozero()" onChange="getLeaveBalance(this.value)">
     ...
     <tr id="dayoption">
          ...
          <div id="ajaxdate">
        	<input type="text" id="days_d" name="days_d" value="1" <cfif aLeave_qry.c_leavebalance neq '1'>onkeyup="validhalf(this.value);controlbalance();"<cfelse>onkeyup="validhalf(this.value);"</cfif> /><!--- <cfif DSNAME eq 'uniq_p' or DSNAME eq 'maven_p' or DSNAME eq 'kjcpl_p' or DSNAME eq 'viva_p' or DSNAME eq 'mlpl_p'>readonly</cfif> --->
            </div>
