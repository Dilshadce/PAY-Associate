...
<div class="tabber">
        ...
        <tr>
          <th>Leave Type</th>
          <td>:</td>
          <td><select id="leaveType" name="leaveType" Onclick="caldays()" onChange="getLeaveBalance(this.value);showMCAttachment(this.value);">
        ...
        <tr>
            ...
            <td>:</td>
            <td>
                <input type="text" size="15" name="dateTo" id="dateTo" value="" readonly />
