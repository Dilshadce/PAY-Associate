...
<cfquery name="comp_details" datasource="payroll_main">
	SELECT mon,tue,wed,thu,fri,sat,sun,ncltoal,leavedays,daysinadvance FROM gsetup2 WHERE comp_id = <cfqueryparam cfsqltype="cf_sql_varchar" value="#HcomID#">
</cfquery>
...
<div class="tabber">
        ...
        <tr>
          <th>Leave Type</th>
          <td>:</td>
          <td><select id="leaveType" name="leaveType" onchange="if(this.value == 'NCL' || this.value == 'TOff'){show_row('time');} else {show_row('days');}" Onclick="changeTozero()">
