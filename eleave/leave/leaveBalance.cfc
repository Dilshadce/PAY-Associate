<cffunction name="getBalance" access="remote" returnFormat="json">
    ...
    <cfargument name="leavestart" type="date" required="yes" />
    <cfargument name="leaveend" type="date" required="yes" />
    ...
    <cfif "#earnleave#" EQ "Y">
        ...
        <cfset currentdays = #DateDiff('d', "#LsDateFormat(getLeaveTaken.startdate, 'yyyy-mm-dd')#", "#LsDateFormat(leaveend, 'yyyy-mm-dd', 'English (Australian)')#")# + 1>
