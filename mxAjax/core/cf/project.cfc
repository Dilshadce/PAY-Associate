<cfcomponent extends="mxAjax">
	<cffunction name="checkProjectExist" returntype="struct">
		...
		<cfif arguments.code neq "">
			<cfquery datasource="#dts#" name="qryData">
				SELECT project
				FROM project
				WHERE project = <cfqueryparam cfsqltype="cf_sql_varchar" value="#arguments.code#">
			</cfquery>
			
			<cfif qryData.recordcount>
				<cfset retData.exist=true>
				<cfset retData.message="This Project #UCase(arguments.code)# already EXISTS!">
			</cfif>
		</cfif>
