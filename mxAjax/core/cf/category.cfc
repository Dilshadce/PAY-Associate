<cfcomponent extends="mxAjax">
	<cffunction name="checkCategoryExist" returntype="struct">
		...
		<cfif arguments.code neq "">
			<cfquery datasource="#dts#" name="qryData">
				SELECT category
				FROM category 
				WHERE category = <cfqueryparam cfsqltype="cf_sql_varchar" value="#arguments.code#">
			</cfquery>
			
			<cfif qryData.recordcount>
				<cfset retData.exist=true>
				<cfset retData.message="This Category #UCase(arguments.code)# already EXISTS!">
			</cfif>
		</cfif>
