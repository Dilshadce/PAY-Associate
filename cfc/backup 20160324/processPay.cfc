...
<!---                <cfif net GTE "5001" AND net LTE "20000">
                    <cfset M = "5000">
                    <cfset R = "0.01">
					<cfif cate eq "1" OR cate eq "3" >
                        <cfset B = "-400">
                    </cfif>
                    <cfif cate eq "2">
                        <cfset B = "-800">
                ...
                <cfif net GTE "20001" AND net LTE "35000">
                    <cfset M = "20000">
                    <cfset R = "0.05">
					<cfif cate eq "1" OR cate eq "3" >
                        <cfset B = "-250">
                ...
                <cfif net GTE "35001" AND net LTE "50000">
                    <cfset M = "35000">
                    <cfset R = "0.10">
					<cfif cate eq "1" OR cate eq "3" >
                        <cfset B = "900">
                ...
                <cfif net GTE "50001" AND net LTE "70000">
                    <cfset M = "50000">
                    <cfset R = "0.16">
					<cfif cate eq "1" OR cate eq "3" >
                        <cfset B = "2400">
                ...
                <cfif net GTE "70001" AND net LTE "100000">
                    <cfset M = "70000">
                    <cfset R = "0.21">
					<cfif cate eq "1" OR cate eq "3" >
                        <cfset B = "5600">
                ...
                <cfif net GTE "100001" AND net LTE "250000">
                    <cfset M = "100000">
                    <cfset R = "0.24">
					<cfif cate eq "1" OR cate eq "3" >
                        <cfset B = "11900">
                ...
                <cfif net GTE "250001" AND net LTE "400000">
                    <cfset M = "250000">
                    <cfset R = "0.245">
					<cfif cate eq "1" OR cate eq "3" >
                        <cfset B = "47900">
...
--->
            ...
            <cfif val(checkbonus.bonus) gt 0 >
                ...
                <cfif bavgepf gt val(pbonusepf)+val(epfnow)>
                    <cfset bavgepf = pbonusepf>
                </cfif>
                <cfif bavgepf lt 0>
                    <cfset bavgepf = 0>
                </cfif>
...
<!---                <cfif net GTE "5001" AND net LTE "20000">
                ...
                <!--- END TABLE --->
--->            
				<cfset pcbbonus =  numberformat((net-m)*r+b,'.__')>
...
<!---
<cfif GetAuthUser() eq 'ultramax' or getauthuser() eq  'ultracai'>
   <!---<cfif empno eq '001'> --->
    <cfoutput>
    ...
    <!---</cfif> --->
        ...
        <cfquery name="update_pcb_to_paytran" datasource="#db#">
		      UPDATE paytran SET DED115 = #currentpcb#, itaxpcb = #pcbgrosspay# WHERE empno = "#empno#"
		</cfquery>

        <cfset tded = #deduc# + #currentpcb#>
