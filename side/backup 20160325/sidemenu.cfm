...
<div class="section">
	<ul id="menu" class="accordion">
		...
		<cfif lcase(dts) eq "gaf20_p">
		<li id="itemtestgaf" class="itemtestgaf"><a href="" target="mainFrame">Employee Data</a>
			<ul class="sub-menu">
					<li id="itemtestgaf2" class="itemtestgaf2"><a href="/miscellaneous/printOtherReports/ImportData/importattmain.cfm" target="mainFrame">Import Data</a></li>
			</ul>
		</li>	
