...
<div class="section">
	<ul id="menu" class="accordion">
        ...
        <cfif getauthuser() EQ "test3@gmail.com">
            <li id="itemMP1" class="itemMP1"><a href="" target="mainFrame">Approval (Beta)</a>
                <ul class="sub-menu">
        ...
        <cfif getauthuser() EQ "test3@gmail.com" OR getauthuser() EQ "1rishi@my.ibm.com" OR getauthuser() EQ "hani@my.ibm.com">
