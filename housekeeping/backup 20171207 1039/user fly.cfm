...
<cfif url.type eq "Edit">
	<cfquery datasource='payroll_main' name="getUsers">
		select * 
		from users 
		where userId=<cfqueryparam cfsqltype="cf_sql_varchar" value="#trim(urldecode(url.userId))#">;
	</cfquery>
	...
	<cfelse>
		...
		<form name="done" action="vUser1.cfm?process=done" method="post">
...
<td width="300px">
    	...
    	<tr> 
			<th width="200px">Enter Password Again</thtd>
			<td width="300px">
				<cfif mode eq "Delete">
