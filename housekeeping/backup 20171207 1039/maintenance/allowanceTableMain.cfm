	...
	<div class="tabber">
		...
		<div class="tabbertab">
			...
			<tr>
				...
				<th width="8%">Description</th>
				<th width="2%">Type</th>
				<th width="50%">Formula for type F and V</th>
				<th width="5%">Ceiling</th>
				<th rowspan="18" >
			...
			<tr <cfif at_qry.aw_cou gt 17> style="display:none"</cfif>>
				...
				<td><input type="text" name="aw_ceil__r#at_qry.aw_cou#" value="#at_qry.aw_ceil#" size="10" maxlength="10" /></td>
			</tr>
			</cfoutput>
			<tr>
		...
		<div class="tabbertab">
            ...
            <table class="form" border="0">
                ...
                <cfloop query="at_qry">
                <tr <cfif at_qry.aw_cou gt 17> style="display:none"</cfif>>
                	<td>#at_qry.currentrow#</td>
                	<td><input id="rmk#at_qry.currentrow#" name="rmk#at_qry.currentrow#" value="#at_qry.aw_rmk#" size="100" ></td>
	            </tr>
                </cfloop>
