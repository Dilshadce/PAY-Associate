		...
		<div class="tabbertab">
			...
			<tr><td>Source</td>
				<td colspan="3">
					...
					</select><cfif HuserCcode eq "SG">**For IR8A E-Submission Purpose</cfif></td>
			</tr>
			...
			<tr>
			  <td><cfif HuserCcode eq "MY">Socso ID<cfelse>Organization ID No.</cfif></td>
			  <td colspan="3"><input type="text" name="UEN" value="#gs_qry.uen#" size="20" maxlength="10"  /><cfif HuserCcode eq "SG">**For IR8A E-Submission Purpose</cfif></td>
			</tr>
			<tr>
		...
		<div class="tabbertab">
            ...
            <tr>
				...
				<td colspan="3">
					...
					</select>   ** Please process all leave(s) before change
				</td>
			</tr>
            <tr>
            ...
            <tr>
				...
				<td colspan="3">
					...
					</select>   ** Please process all claim(s) before change
				</td>
			</tr> 
