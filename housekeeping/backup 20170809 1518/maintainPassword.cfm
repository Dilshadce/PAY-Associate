...
<cfform action="/housekeeping/maintainPasswordProcess.cfm" method="post" onsubmit="javascript:validatepass();">
<table class="form">
<tr>
...
<br />
<br />
&nbsp;&nbsp;&nbsp;<cfinput type="submit" name="changepass" id="changepass" value="ok" size="6" > <!---style="visibility:hidden"---> 
</cfform>
</cfoutput>
</body>
</html>