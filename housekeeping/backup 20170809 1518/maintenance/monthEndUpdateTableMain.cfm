...
SELECT meud_brate,meud_hol,meud_rdph,meud_leave,meud_loan,meud_mbr,MEUD_BRATEFLEX,meud_lveEnt FROM awtable WHERE aw_cou='1'
</cfquery>
...
<table class="insert" border="0">
	...
	<tr>
		<td><input type="checkbox" name="check7" value="Y" #IIF(meu_qry.meud_lveEnt eq "N",DE(""),DE("checked"))# /></td>
		<td>Update Leave Entitlement</td>
	</tr>
	<tr>
