	...
	<div class="tabber">
        ...
        <div class="tabbertab">
            ...
            <tr>
                ...
                <td />
                <td>Current Auto Pilot Status - #gs_qry2.pilotstage#</td>
                <td />
            </tr>
            <tr>
                ...
                <td />
                <td>0 - Collecting Information</td>
                <td />
            </tr>
            <tr>
                <td />
                <td />
                <td>1 - Email Payroll Reminder</td>
                <td />
            </tr>
            <tr>
                <td />
                <td />
                <td>2 - Processing Payroll</td>
                <td />
            </tr>
                <td />
                <td />
                <td>3 - Email Summary Report</td>
                <td />
            </table>    
        </div>
