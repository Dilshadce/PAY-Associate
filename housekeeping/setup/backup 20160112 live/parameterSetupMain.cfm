...
<body>
	...
	<div class="tabber">
        ...
        <div class="tabbertab">
            ...
            <tr>
				<td><input type="checkbox" name="autopilot" id="autopilot" onclick="pilotday.value=1" <cfif gs_qry2.autopilot eq "Y">checked</cfif>>
            ...
            <tr>
				<td><input type="checkbox" name="informstatus" id="informstatus" onclick="informday.value=2" <cfif gs_qry2.informstatus eq "Y">checked</cfif>>
