...
<form action="/housekeeping/monthEndProcess.cfm" method="post" onsubmit="if(confirm('Are you sure want to month end?')){ColdFusion.Window.show('processing'); return true;}else{return false;}">
<table class="form">
<tr>
<td>&nbsp;</td>
<td>&nbsp;</td>
...
<tr>
  ...
  <td align="right">&nbsp;</td>
		...
		<br />	
		&nbsp;&nbsp;&nbsp;<input type="submit" name="save" value="ok" <cfif mon eq 13> style="display:none" disabled="disabled"  </cfif>>
</form>
</div>
</cfoutput>
