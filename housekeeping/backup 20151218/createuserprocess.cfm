...
INSERT INTO users (entryID, userID, userPWD, userGrpID, userName, userCmpID, userDsn, userCty, userEmail, userDirectory,getmail)
VALUES ("#username#","#username#", "#password#", "#group#","#username#", "#user_detail.userCmpID#", "#user_detail.userDsn#", "#user_detail.userCty#","#userEmail#","default",<cfif isdefined('form.getmail')>"Y"<cfelse>"N"</cfif>) 
</cfquery>
 <cfset status_msg = "User Successfully Created" >
</cfif>

<cfoutput><form name="pc" action="/housekeeping/createuser.cfm?id=#url.id#" method="post"></cfoutput>
