...
<form action="/housekeeping/createuserprocess.cfm?companyID=#url.companyID#" method="post" onsubmit="return validatepass();">
  <table>
<tr>
...
<tr>
 <tr><td>Choose UserGroup</td>
	 <td><select name="userGrpID">
				...
				<cfquery name="userpin_qry" datasource="#url.companyID#">
					SELECT * from userpin
				</cfquery>
...
<tr><td>Company Id:</td><td>#url.companyID#</td></tr>
<tr>
    <td>Receive Email</td>
    <td>
...
<td>Pilot Summary Report</td>
    <td>
    <input type="checkbox" name="pilotrep" id="pilotrep" value="Y">
    </td>
</tr>
<tr>
    <td>Mobile Access</td>
    <td>
    <input type="checkbox" name="mobileaccess" id="mobileaccess" value="N">
    </td>
</tr>
</table>
<br />
