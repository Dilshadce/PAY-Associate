...
UPDATE awtable SET 
       ...
       aw_rmk = <cfqueryparam value="#evaluate('form.rmk#i#')#" cfsqltype="CF_SQL_varchar">,
       aw_ceil = <cfqueryparam value="#evaluate('val(form.aw_ceil__r#i#)')#" cfsqltype="CF_SQL_varchar">
	   WHERE aw_cou= '#i#'
