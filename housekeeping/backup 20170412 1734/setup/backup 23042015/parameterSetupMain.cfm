	...
	<div class="tabber">
		<div class="tabbertab">
			...
			<tr>
				...
				<td colspan="3"><input type="text" name="comp_name" value="#gs_qry.comp_name#" size="80" maxlength="80" />**For IR8A E-Submission Purpose</td>
			</tr>
			<tr>
				<td>Address</td>
            ...
            <tr>
            	<td>No. Majikan</td>
                <td colspan="3">E&nbsp;&nbsp;<input type="text" name="nomajikan" value="#gs_qry.nomajikan#" size="20" maxlength="20" /></td
            ></tr>
            <tr>
            	<td>Kod Status</td>
                <td>
                    ...
                    <option value=""></option>
                    <option value="01" #IIF(gs_qry.kodstatus eq "01",DE("selected"),DE(""))#>Kerajaan</option>
                    <option value="02" #IIF(gs_qry.kodstatus eq "02",DE("selected"),DE(""))#>Kerajaan Berkomputer*</option>
                    <option value="03" #IIF(gs_qry.kodstatus eq "03",DE("selected"),DE(""))#>Berkanun</option>
                    <option value="04" #IIF(gs_qry.kodstatus eq "04",DE("selected"),DE(""))#>Berkanun Berkomputer*</option>
                    <option value="05" #IIF(gs_qry.kodstatus eq "05",DE("selected"),DE(""))#>Swasta</option>
                    <option value="06" #IIF(gs_qry.kodstatus eq "06",DE("selected"),DE(""))#>Swasta Berkomputer*</option>
                    <option value="07" #IIF(gs_qry.kodstatus eq "07",DE("selected"),DE(""))#>Pusat Pengajian Kerajaan</option>
                    <option value="08" #IIF(gs_qry.kodstatus eq "08",DE("selected"),DE(""))#>Pusat Pengajian Kerajaan Berkomputer*</option>
                    <option value="09" #IIF(gs_qry.kodstatus eq "09",DE("selected"),DE(""))#>Pusat Pengajian Swasta</option>
                    <option value="10" #IIF(gs_qry.kodstatus eq "10",DE("selected"),DE(""))#>Pusat Pengajian Swasta Berkomputer*</option>
                    <option value="11" #IIF(gs_qry.kodstatus eq "11",DE("selected"),DE(""))#>Tenera</option>
                	</select>
               </td>
            </tr>
            </cfif>
			...
			<tr>
			  <td>Organization ID No.</td>
			  <td colspan="3"><input type="text" name="UEN" value="#gs_qry.uen#" size="20" maxlength="10"  />**For IR8A E-Submission Purpose</td>
			</tr>
			<tr>
			...
			<tr>
				...
				<td colspan="3"><input type="text" name="authorised_name" value="#gs_qry.authorised_name#" size="20" maxlength="30"  />**For IR8A E-Submission Purpose</td>
			</tr>
            <tr>
				<td>Email of authorised person</td>
				<td colspan="3"><input type="text" name="authorised_email" value="#gs_qry.authorised_email#" size="20" maxlength="30"  />**For IR8A E-Submission Purpose</td>
			</tr>
			<tr>
		...
		<div class="tabbertab">
            ...
            <tr>
				<td width="300">No Calculation For SDL if CPF category is X</td>
		...
		<div class="tabbertab">
            ...
            <tr>
				...
				<td colspan="3">
					...
					<option value="adminonly" #IIF(gs_qry.eleaveapp eq "adminonly",DE("selected"),DE(""))#>Admin Approve Only</option>
                    <option value="deptonly" #IIF(gs_qry.eleaveapp eq "deptonly",DE("selected"),DE(""))#>Head Of Department Approve Only</option>
                    <option value="deptadmin" #IIF(gs_qry.eleaveapp eq "deptadmin",DE("selected"),DE(""))#>Head Of Department Approve then Admin Approve</option>
                    <option value="admindept" #IIF(gs_qry.eleaveapp eq "admindept",DE("selected"),DE(""))#>Admin Approve then Head Of Department Approve</option>
					</select>
				</td>
			</tr>
            <tr>
				<td colspan="2">Send Leave Approval Notification</td>
				<td colspan="3">
					<select name="leaveapproval">
					<option value="everyone" #IIF(gs_qry.leaveapproval eq "everyone",DE("selected"),DE(""))#>Approve by Everyone</option>
                    <option value="deptonly" #IIF(gs_qry.leaveapproval eq "deptonly",DE("selected"),DE(""))#>Approve by Department Only</option>
					</select>
				</td>
			</tr>
            <tr>
            	<td colspan="2">Receive Leave Notification</td>
				<td colspan="3">
					<select name="leavereceived">
					<option value="everyone" #IIF(gs_qry.leavereceived eq "everyone",DE("selected"),DE(""))#>Receive by Everyone</option>
                    <option value="deptonly" #IIF(gs_qry.leavereceived eq "deptonly",DE("selected"),DE(""))#>Receive by Department Only</option>
					</select>
				</td>
            </tr>
			<tr>
            ...
            <tr>
				<td><input type="checkbox" name="editadd" id="editadd" <cfif gs_qry.editadd eq "Y">checked</cfif>>Not allow employee change address in E-Leave</td>
				<td></td>
				<td></td>
