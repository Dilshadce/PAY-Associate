...
<cfset currentFile="http://localhost/government/IR8A/PrintIR8SUpdateMain.cfm">
...
<body>
				...
				<cfif getData.recordcount>
					...
					<tr>
						...
						<td>
	           			...
	           			<td width="">
		           			<a href=## onclick="window.open('/government/IR8A/PrintIR8SUpdateForm.cfm?empno=#getData.empno#', 'windowname1', 'width=1140, height=650, left=100, top=100, scrollbars=yes')"><img height="18px" width="18px" src="/images/edit.ICO" alt="Edit" border="0">Update</a>
						</td>
					</tr>
					</cfoutput>
				<cfelse>
		...
		<div><br /><a href="/government/IR8A/printIR8SMain.cfm"><strong>< Back</strong></a></div>
