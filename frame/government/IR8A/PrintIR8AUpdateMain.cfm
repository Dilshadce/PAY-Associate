...
<!---cfset currentFile="http://localhost/government/IR8A/PrintIR8AUpdateMain.cfm"--->
...
<head>
	...
	<title>Update IR8A Figures Main</title>
	<link rel="stylesheet" href="/stylesheet/app.css"/>
</head>

<body>
		<div class="mainTitle">Update IR8A Figures Main</div>
		<div class="ttype3">
			<cfoutput>
			...
			<span class="ttype">Search By :
				<select name="sType">
				  ...
				  <option value="nricn">Employee IC</option>
			    </select>
				Search for : 
				...
				<cfif getData.recordcount>
					...
					<tr>
						...
						<td>
	           			...
	           			<td width="">
		           			<a href=##   onclick="window.open('/government/IR8A/PrintIR8AUpdateForm.cfm?empno=#getData.empno#', 'windowname1', 'width=950, height=650, left=100, top=100, scrollbars=yes')"><img height="18px" width="18px" src="/images/edit.ICO" alt="Edit" border="0">Update</a>
						</td>
					</tr>
					</cfoutput>
				<cfelse>
		...
		<div><br /><a href="/government/IR8A/printIR8AMain.cfm"><strong>< Back</strong></a></div>
</body>
</html>
