...
<div class="mainTitle">Appendix 8A</div>
...
<table class="form">
	...
	<tr>
		<th>Credit Date</th>
		<td><input type="text" name="cdate" value="" size="10">
...
<br/>
	...
	<center>
		<input type="button" name="update" value="Update" onClick="window.location.href='Appendix8AUpdateMain.cfm';">
