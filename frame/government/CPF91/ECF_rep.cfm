...
SELECT a.empno,b.empno,name,epfno,DED115
FROM pmast AS a LEFT JOIN pay_tm AS b ON a.empno=b.empno
WHERE epfcat = '#form.cat#'AND DED115 !="0.00" AND paystatus = "A" and confid >= #hpin#
...
<table width="100%">
	<cfoutput>
	<tr><td colspan="100%" align="center"><h1>EURASIAN COMMUNITY FUND</h1></tr>
	<tr>
	...
	<tr>
		...
		<td width="140px" align ="right">#numberformat(getList_qry.ded115,'.__')#</td>
	</tr>
	<cfset i = i + 1>
    <cfset total_EU = total_EU + #val(getList_qry.ded115)# >
	</cfoutput>
	<tr>
	...
	<tr>
		...
		<td width="140px" align ="right">#numberformat(total_EU,'.__')#</td>
	</tr>
	<tr>
		<td colspan="3">&nbsp</td>		
...
<cfheader name="Content-Disposition" value="attachment; filename=ECFReport.pdf">
