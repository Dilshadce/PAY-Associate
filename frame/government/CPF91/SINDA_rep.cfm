...
SELECT a.empno,b.empno,name,epfno,DED113
FROM pmast AS a LEFT JOIN pay_tm AS b ON a.empno=b.empno
WHERE epfcat = '#form.cat#' AND DED113 !="0.00" AND paystatus = "A" and confid >= #hpin#
...
<table width="100%">
	<cfoutput>
	<tr><td colspan="4" align="center"><h1>SINDA FUND</h1></tr>
	<tr>
	...
	<tr>
		...
		<td width="140px" align="right">#numberformat(getList_qry.DED113,'.__')#</td>
	</tr>
	<cfset i = i + 1>
    <cfset total_SINDA = total_SINDA + #val(getList_qry.DED113)#>
	</cfoutput>
	<tr>
	...
	<tr>
		...
		<td width="140px" align="right">#numberformat(total_SINDA,'.__')#</td>
	</tr>
	<tr>
		<td colspan="3">&nbsp</td>		
...
<cfheader name="Content-Disposition" value="attachment; filename=SINDAReport.pdf">
