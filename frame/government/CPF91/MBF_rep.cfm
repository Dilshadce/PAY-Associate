...
SELECT a.empno,b.empno,name,epfno,DED111
FROM pmast AS a LEFT JOIN pay_tm AS b ON a.empno=b.empno
WHERE epfcat = '#form.cat#' AND DED111 !="0.00" AND paystatus = "A" and confid >= #hpin#
...
<head>
	...
	<title>Mosque Building Fund</title>
...
<table width="100%">
	<cfoutput>
	<tr><td colspan="4" align="center"><h1>MOSQUE BUILDING FUND</h1></tr>
	<tr>
	...
	<tr>
		...
		<td width="140px" align="right">#numberformat(getList_qry.DED111,'.__')#</td>
	</tr>
	<cfset i = i + 1>
	
    <cfset total_MBF = total_MBF + #VAL(getList_qry.DED111)# >
	</cfoutput>
	<tr>
	...
	<tr>
		...
		<td width="140px" align="right">#numberformat(total_MBF,'.__')#</td>
	</tr>
	<tr>
		<td colspan="3">&nbsp</td>		
...
<cfheader name="Content-Disposition" value="attachment; filename=MBFReport.pdf">
...
<table width="100%">
	...
	<cfset i = i + 1>
    <cfset total_MBF = total_MBF + #getList_qry.DED111# >
	</cfoutput>
	<tr>
		<td colspan="3">&nbsp</td>		
		<td width="140px"><hr></td>
