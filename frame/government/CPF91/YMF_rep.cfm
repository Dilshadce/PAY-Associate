...
SELECT a.empno,b.empno,name,epfno,DED109
FROM pmast AS a LEFT JOIN pay_tm AS b ON a.empno=b.empno
WHERE epfcat = '#form.cat#' AND ded109 !="0.00" AND paystatus = "A" and confid >= #hpin#
</cfquery>
...
<table width="100%">
	<cfoutput>
	<tr><td colspan="4" align="center"><h1>YAYASAN MENDAKI FUND</h1></tr>
	<tr>
	...
	<tr>
		...
		<td width="140px" align="right">#numberformat(getList_qry.ded109,'.__')#</td>
	</tr>
	<cfset i = i + 1>
    <cfset total_YMF = total_YMF + #val(getList_qry.ded109)#>
	</cfoutput>
	<tr>
	...
	<tr>
		...
		<td width="140px" align="right">#numberformat(total_YMF,'.__')#</td>
	</tr>
	<tr>
		<td colspan="3">&nbsp</td>		
...
<cfheader name="Content-Disposition" value="attachment; filename=YMFReport.pdf">
