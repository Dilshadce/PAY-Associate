...
SELECT a.empno,b.empno,name,epfno,DED114
FROM pmast AS a LEFT JOIN pay_tm AS b ON a.empno=b.empno
WHERE epfcat = '#form.cat#' AND DED114 !="0.00" AND paystatus = "A"
...
<table width="100%">
	<cfoutput>
	<tr><td colspan="4" align="center"><h1>CDAC FUND</h1></tr>
	<tr>
	...
	<tr>
		...
		<td width="140px" align="right">#numberformat(getList_qry.ded114, '.__')#</td>
	</tr>
	<cfset i = i + 1>
    <cfset total_CDAC = total_CDAC + #val(getList_qry.ded114)# >
	</cfoutput>
	<tr>
	...
	<tr>
		...
		<td width="140px" align="right">#numberformat(total_CDAC, '.__')#</td>
	</tr>
	<tr>
		<td colspan="3">&nbsp</td>		
...
<cfheader name="Content-Disposition" value="attachment; filename=CDACReport.pdf">
