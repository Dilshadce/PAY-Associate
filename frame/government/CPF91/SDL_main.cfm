<html>
<head>
	<title>Skills Development Levy (SDL)</title>
...
<div class="mainTitle">CPF91 Skills Development Levy (SDL)</div>
<div class="tabber">
<form name="gForm" action="SDL_rep.cfm" method="post" target="_blank">
<table class="form">
	<tr>
		<th>Report Format</th>
		<td>
