...
<link rel="stylesheet" href="/css/body/searchresult.css" />
<!--[if lt IE 9]>
...
<script type="text/javascript" src="/js/body/searchresult.js"></script>
</head>
<body>
<div class="container">
	...
	<div class="container">
		<table id="resultTable" class="table table-bordered table-hover resultTable" style="table-layout:fixed">
			<thead>
			</thead>
			<tbody>
			</tbody>
