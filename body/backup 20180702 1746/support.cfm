		...
		<div class="row">
			<div class="col-sm-4">
				...
				<div class="row">
					...
					<h4 class="text-muted col-sm-4 btmSubContent">+603 56149000</h4>
					<div class="col-sm-2"></div>
				</div>
				<div class="row">
					<div class="col-sm-2"></div>
			...
			<div class="col-sm-4" id="remoteAssistanceDiv">
				...
				<a href="http://download.teamviewer.com/download/version_10x/TeamViewer_Setup.exe" target="_self"><h4 class="text-muted text-center btmSubContent">Team Viewer >></h4></a><br />
				<a href="http://download3.showmypc.com/ShowMyPC3160.exe" target="_self"><h4 class="text-muted text-center btmSubContent">ShowMyPc >></h4></a><br />
			</div>
			<div class="col-sm-4">
