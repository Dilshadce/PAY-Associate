...
<div class="tabber">
			<div class="tabbertab">
                ...
                <td>:</td>
                <td>
              	<cfinput type="text" name="dbirth" id="dbirth" value="#dateformat(getempdetails.dbirth,'dd/mm/yyyy')#" maxlength="10" required="yes" message="Date of Birth is Required!">&nbsp;&nbsp;<img src="/images/cal.gif" width=17 height=15 border=0 onClick="showCalendarControl(document.getElementById('dbirth'));">&nbsp;(dd/mm/yyyy)
                </td>
                </tr>
                <tr>
                <th>Gender</th>
...
ORDER BY cname
                ...
                <td>:</td>
                <td><cfselect id="Country_Code_address" name="Country_Code_address" >
                ...
                <td>:</td>
                <td>
              	<cfinput type="text" name="passprt_to" id="passprt_to" value="#dateformat(getempdetails.passprt_to,'dd/mm/yyyy')#" maxlength="10" validate="eurodate" validateat="onsubmit" message="Passport Expiring Date is Invalid">&nbsp;&nbsp;<img src="/images/cal.gif" width=17 height=15 border=0 onClick="showCalendarControl(document.getElementById('passprt_to'));">&nbsp;(dd/mm/yyyy)
                </td>
                </tr>
                <tr>
                ...
                <th>Nationality</th>
                <td>:</td>
                <td><cfselect id="national" name="national">
					<cfloop query="country_qry">
            ...
            <div class="tabbertab">
                ...
                <td>:</td>
                <td>
                   <cfinput type="text" name="itaxno" id="itaxno" value="#getempdetails.itaxno#" maxlength="20" size="70">    
                </td>
                </tr>
                <tr>
                <th>Tax Branch</th>
               ...
               <tr id="s1" <cfif getempdetails.sname eq ""> style="display:none"</cfif>>
				...
				<tr>
                <td colspan="100%">
                <div id="childrelief" <cfif getempdetails.sex eq "F">style="display:none"</cfif>>
                <table>
                <tr>
                <th>## Child</th>
                <td>:</td>
             ...
             <div class="tabbertab">
                ...
                SELECT username, userid FROM hmusers WHERE entryid = <cfqueryparam cfsqltype="cf_sql_varchar" value="#getplacement.hrmgr#">
                </cfquery>
                ...
                <td>:</td>
                <td>
              	<cfinput type="text" name="wp_from" id="wp_from" value="#dateformat(getempdetails.wp_from,'dd/mm/yyyy')#" maxlength="10" validate="eurodate" validateat="onsubmit" message="Employment Pass Valid From is Invalid">&nbsp;&nbsp;<img src="/images/cal.gif" width=17 height=15 border=0 onClick="showCalendarControl(document.getElementById('wp_from'));">&nbsp;(dd/mm/yyyy)
                </td>
                </tr>
                <tr>
                ...
                <td>:</td>
                <td>
              	<cfinput type="text" name="wp_to" id="wp_to" value="#dateformat(getempdetails.wp_to,'dd/mm/yyyy')#" maxlength="10" validate="eurodate" validateat="onsubmit" message="Employment Pass Valid To is Invalid">&nbsp;&nbsp;<img src="/images/cal.gif" width=17 height=15 border=0 onClick="showCalendarControl(document.getElementById('wp_to'));">&nbsp;(dd/mm/yyyy)
                </td>
                </tr>
                ...
                <td>:</td>
                <td>
                   <cfinput type="text" name="bankaccno" id="bankaccno" value="#getempdetails.bankaccno#" maxlength="20" size="70" required="yes" message="Bank Account No is Required">    
                </td>
                </tr>
                <tr>
...
<table>
<tr>
<th colspan="100%">Leave Utilization (until 31/10/2016)</th>
</tr>
<tr>
<th>Leave Type</th>
<th>Start Date</th>
...
<tr>
        ...
        <td>
        <input type="text" name="startdate" id="startdate"  size="12" />&nbsp;<img src="/images/cal.gif" width=17 height=15 border=0 onClick="showCalendarControlmp(document.getElementById('startdate'));">
        </td>
        <td>
        ...
        <td>
        <input type="text" name="enddate" id="enddate" size="12" />&nbsp;<img src="/images/cal.gif" width=17 height=15 border=0 onClick="showCalendarControlmp(document.getElementById('enddate'));">
        </td>
        <td>
