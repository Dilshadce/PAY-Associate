...
<cfif form.placementno neq "test">
...
<cfif getplacement.hrmgr neq "">
    ...
    SELECT username, userid FROM hmusers WHERE 
...
<script type="text/javascript">
alert('Update Sucess! For some data, the update will only reflected in after 48 hours.');
