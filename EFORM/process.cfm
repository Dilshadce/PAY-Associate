<cfif isdefined('form.placementno')>
    ...
    <cfoutput>
        <cfset dts = dsname>
        <cfquery datasource="#replace(dts,'_p','_i')#">
        ...
        <cftry>
            ...
            <cfcatch type="any">
                <cfmail from="debug@manpower.com.my" to="alvin.hen@manpower.com.my" subject="debug" type="html">
                    <p>#cfcatch.message#</p>
                    <p>Caught an exception, type = #CFCATCH.TYPE# </p>
                    <p>database is: #replace(dts,'_p','_i')#</p>
                    <p>UPDATE placement 
        ...
        <script type="text/javascript">
            alert('Update Successful! The updates will be reflected within 48 hours.');
