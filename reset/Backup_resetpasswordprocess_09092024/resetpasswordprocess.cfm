...
<cfoutput>
    ...
    <cfquery name="checkhm" datasource="payroll_main">                            <!---Check hiring manager validity--->
        SELECT userid, username, useremail FROM hmusers WHERE userid = <cfinput name="username" value="#trim(form.userid)#">
    </cfquery>
    ...
    <cfquery name="checkuser" datasource="manpower_p">                        <!---Check associate validity--->
        ...
        WHERE emp.username = <cfinput name="username" value="#trim(form.userid)#">
    </cfquery>
    ...
    <cfquery name="log_reset" datasource="manpower_p">
       ...
       VALUES
       (<cfinput name="username" value="#trim(form.userid)#">, now())        
    </cfquery>
