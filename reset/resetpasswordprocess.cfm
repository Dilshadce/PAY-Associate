...
<cfoutput>
    ...
    <cfquery name="checkhm" datasource="payroll_main">                            <!---Check hiring manager validity--->
        SELECT userid, username, useremail FROM hmusers WHERE userid = <cfqueryparam cfsqltype="cf_sql_varchar" value="#trim(form.userid)#">
    </cfquery>
    ...
    <cfquery name="checkuser" datasource="manpower_p">                        <!---Check associate validity--->
        ...
        WHERE emp.username = <cfqueryparam cfsqltype="cf_sql_varchar" value="#trim(form.userid)#">
    </cfquery>
    ...
    <cfif checkhm.recordcount NEQ 0>
    ...
    <cfquery name="log_reset" datasource="manpower_p">
       ...
       VALUES
       (<cfqueryparam cfsqltype="cf_sql_varchar" value="#trim(form.userid)#">, now())        
    </cfquery>
