...
//}	
	var resultTable=$('#resultTable')
		.dataTable({
			...
			'aoColumnDefs':[
				{'aTargets':[0],'sTitle':'EMPLOYEE NO','mData':'bempno','bSortable':true,'sWidth':'10%'},
...
//					'bVisible':visibleC,
					...
					'mRender':function(data,type,row){
						return 	'<span class="glyphicon glyphicon-list btn btn-link" '+
								'onclick="window.open(\'\/payments\/1stHalf\/viewPaySlipForm.cfm?empno='+escape(encodeURIComponent(data))+'\',\'_self\');"></span>';
...
*/								
			...
			'sAjaxSource':'/payments/1stHalf/viewPaySlipProfile.cfc',
			'sServerMethod':'POST',
        	'sScrollX':'100%'
		})
		.fadeIn();
