...
//					'bVisible':visibleC,
					...
					'mRender':function(data,type,row){
						return 	'<span class="glyphicon glyphicon-pencil btn btn-link" '+
								'onclick="window.open(\'\/payments\/1stHalf\/AddUpdate\/editOTRateCPFForm.cfm?empno='+escape(encodeURIComponent(data))+'\',\'_self\');"></span>';
...
*/								
			...
			'sAjaxSource':'/payments/1stHalf/AddUpdate/editOtProfile.cfc',
			'sServerMethod':'POST',
        	'sScrollX':'100%'
		})
		.fadeIn();
