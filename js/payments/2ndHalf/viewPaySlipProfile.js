...
//					'bVisible':visibleC,
					...
					'mRender':function(data,type,row){
						return 	'<span class="glyphicon glyphicon-list btn btn-link" '+
								'onclick="window.open(\'\/payments\/2ndHalf\/viewPaySlipForm.cfm?empno='+escape(encodeURIComponent(data))+'\',\'_self\');"></span>';
...
*/								
			...
			'sAjaxSource':'/payments/2ndHalf/viewPaySlipProfile.cfc',
			'sServerMethod':'POST',
        	'sScrollX':'100%'
		})
		.fadeIn();
