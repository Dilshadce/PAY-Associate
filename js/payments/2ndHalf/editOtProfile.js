...
//					'bVisible':visibleC,
					...
					'mRender':function(data,type,row){
						return 	'<span class="glyphicon glyphicon-pencil btn btn-link" '+
								'onclick="window.open(\'\/payments\/2ndHalf\/AddUpdate\/editOTRateCPFForm.cfm?empno='+escape(encodeURIComponent(data))+'\',\'_self\');"></span>';
...
*/								
			...
			'sAjaxSource':'/payments/2ndHalf/AddUpdate/editOtProfile.cfc',
			'sServerMethod':'POST',
        	'sScrollX':'100%'
		})
		.fadeIn();
