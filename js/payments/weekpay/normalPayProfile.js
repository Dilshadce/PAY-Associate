...
//					'bVisible':visibleC,
					...
					'mRender':function(data,type,row){
						return 	'<span class="glyphicon glyphicon-pencil btn btn-link" '+
								'onclick="window.open(\'\/payments\/WeeklyPayroll\/weekpay\/AddUpdate\/normalPayEditForm.cfm?weektype='+escape(encodeURIComponent(weektype))+'&empno='+escape(encodeURIComponent(data))+'\',\'_self\');"></span>';
...
*/							
			...
			'sAjaxSource':'/payments/weeklyPayroll/weekpay/AddUpdate/normalPayProfile.cfc',
			'sServerMethod':'POST',
        	'sScrollX':'100%'
		})
		.fadeIn();
