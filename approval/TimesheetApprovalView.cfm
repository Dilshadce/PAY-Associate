...
<cfset dateend = "">
<cfset tmonth = ''>
<cfif isdefined('url.datestart') and isdefined("url.dateend") and isdefined("url.pno")  and isdefined("url.tmonth")>
    <cfset pno = url.pno>
    <cfset datestart = url.datestart>
    <cfset dateend = url.dateend>
    <cfset tmonth = url.tmonth>
<cfelse>
    <cfabort>
</cfif>
...
<cfquery name="gettimesheet" datasource="#dts#">
    SELECT * FROM 
    (
        SELECT tm.*, ic.desp FROM timesheet tm
        LEFT JOIN #dts2#.icsizeid ic ON tm.ot_type = ic.sizeid
        WHERE(tm.placementno = <cfqueryparam cfsqltype="cf_sql_varchar" value="#pno#">) 
        AND tm.pdate between <cfqueryparam cfsqltype="cf_sql_varchar" value="#datestart#"> AND <cfqueryparam cfsqltype="cf_sql_varchar" value="#dateend#">  
        ORDER BY tm.pdate
    ) AS sort
    GROUP by pdate	
</cfquery>
...
<cfquery name="emp_data" datasource="#dts#" >
    SELECT * FROM pmast as pm LEFT JOIN emp_users as ep ON pm.empno = ep.empno WHERE ep.empno = "#getplacementlist.empno#"
</cfquery>
...
<cfquery name="holiday_qry" datasource="#dts#">
    ...
    hol_date >= "#dateformat(datestart,'YYYY-MM-DD')#"
    and hol_date <="#dateformat(dateend,'YYYY-MM-DD')#"
</cfquery>
...
<div id="Book1_8828" align=center x:publishsource="Excel">
        ...
        <table border=0 cellpadding=0 cellspacing=0 width=770 style='border-collapse:collapse;table-layout:fixed;width:520pt'>
        <col width=40 span=3 style='width:30pt'>
        <col width=45 span=2 style='width:40pt'>
        <col width=80 span=2 style='width:45pt'>
        <col width=70 span=3 style='width:40pt'>
        <col width=50 span=8 style='width:31pt'>
        ...
        <tr height=20 style='height:15.0pt'>
            ...
            <td colspan=8 class=xl1248828 width=384 style='border-left:none;width:288pt'>Company Name &amp; Address</td>
            <td colspan=10 class=xl898828 width=221 style='width:166pt'>Contact Person &amp; Tel</td>
            <td class=xl158828></td>
            <td class=xl158828></td>
        </tr>
        <tr height=20 style='height:15.0pt'>
            <td colspan=8 height=20 class=xl1028828 style='height:15.0pt;border-left:none'>#getplacementlist.custname#</td>
            <td colspan=10 class=xl1288828 width=221 style='border-left:none;width:166pt'>#getplacementlist.contactperson#</td>
            <td class=xl158828></td>
            <td class=xl158828></td>
        </tr>
        <tr height=20 style='height:15.0pt'>
            <td colspan=8 height=20 class=xl1028828 style='height:15.0pt;border-left:none'>
            ...
            <td colspan=10 class=xl1288828 width=221 style='border-left:none;width:166pt'>#getcustdetail.phone#</td>
            <td class=xl158828></td>
            <td class=xl158828></td>
        </tr>
        <tr height=21 style='mso-height-source:userset;height:15.75pt'>
            ...
            <td colspan=8 class=xl1248828 width=320 style='border-right:1pt solid black;border-left:none;width:240pt'>Name</td>
            <td colspan=10 class=xl1248828 width=128 style='border-right:1pt solid black;border-left:none;width:96pt'>NRIC</td>
        </tr>
        <tr height=20 style='height:15.0pt'>
            <td colspan=8 height=20 class=xl1258828 style='border-right:1pt solid black;height:15.0pt;border-left:none'>#getplacementlist.empname#</td>
            <td colspan=10 class=xl1288828 width=128 style='border-left:none;width:96pt'>
                <cfif "#emp_data.nricn#" NEQ "">#emp_data.nricn#<cfelse>#emp_data.passport#</cfif>
            </td>
            <td>
                <input type="hidden" name="enddate" id="enddate" 
                       value="<cfif gettimesheet.recordcount neq 0>#dateformat(gettimesheet.assigndate,'dd/mm/yyyy')#</cfif> " size="12" readonly>
                <!--- <img src="/images/cal.gif" width=17 height=15 border=0 onClick="showCalendarControl(document.getElementById('enddate'));"> --->
            </td>
        </tr>
        <tr height=20 style='height:15.0pt'>
            ...
            <td class=xl738828 style='border-top:none'>&nbsp;</td>
            <td class=xl738828 style='border-top:none'>&nbsp;</td>
            <td class=xl718828 width=157 style='border-top:none;border-left:none;width:118pt' colspan="2">&nbsp;</td>
            <td class=xl158828></td>
            <td class=xl158828></td>
        </tr>
        <tr height=32 style='height:24.0pt'>
            ...
            <td colspan="2" class=xl838828 width=100 style='border-top:none;border-left:none;width:96pt'>Leave<br>(Full Day/AM/PM)</td>
            ...
            <td class=xl878828 width=36 style='border-top:none;width:24pt'>OT 1.0</td>
            <td class=xl878828 width=36 style='border-top:none;width:24pt;'>OT 1.5</td>
            <td class=xl878828 width=36 style='border-top:none;width:24pt;'>OT 2.0</td>
            <td class=xl878828 width=36 style='border-top:none;width:24pt;'>OT 3.0</td>
            ...
            <td class=xl838828 width=157 style='border-top:none;border-left:none;width:118pt' colspan="2">Remarks</td>
            <td class=xl158828></td>
            <td class=xl158828></td>
        </tr>
        <tr height=32 style='height:24.0pt'>
        ...
        <tr height=20 style='height:15.0pt'>
            <td colspan=20 height=20 class=xl1298828 style='border-right:1pt solid black;border-left:1pt solid black;height:15.0pt'>
            <cftry>
                <cfif month(datestart) eq month(dateend)>
                    #dateformat(datestart,'Mmm yyyy')#
                <cfelse>
                    #dateformat(datestart,'Mmm yyyy')# to #dateformat(dateend,'Mmm yyyy')#
                </cfif>
            <cfcatch>
                #dateformat(datestart,'Mmm yyyy')# to #dateformat(dateend,'Mmm yyyy')#
            </cfcatch>
        ...
        <cfif gettimesheet.recordcount neq 0>
            ...
            <cfloop query="gettimesheet">
                ...
                <tr onMouseOut="javascript:this.style.backgroundColor='';" onMouseOver="javascript:this.style.backgroundColor='f3bd90';" height=20 
                    ...
                    <td class=xl778828 width=64 
                        style='border-top:none;border-left:none;width:48pt;text-align:center;text-overflow: ellipsis;overflow:hidden;white-space: nowrap'>#gettimesheet.desp#</td>
                    ...
                    <td class=xl778828 width=64 style='border-top:none;border-left:none;width:48pt;text-align:center'>
                        ...
                        #timeformat(dateadd('n',numberformat(gettimesheet.breaktime*60,'.__'),timenow),'HH:MM')#
                            <!--- #replace(numberformat(gettimesheet.breaktime*60,'00.__'),'.',':')# --->
                    </td>
                    ...
                    <td class=xl798828 width=64 style='border-top:none;border-left:none;width:48pt;text-align:center'>#numberformat(gettimesheet.ot1,'.__')#</td>
                    <td class=xl798828 width=64 style='border-top:none;border-left:none;width:48pt;text-align:center'>#numberformat(gettimesheet.ot2,'.__')#</td>
                    <td class=xl798828 width=64 style='border-top:none;border-left:none;width:48pt;text-align:center'>#numberformat(gettimesheet.ot3,'.__')#</td>
                    <td class=xl798828 width=64 style='border-top:none;border-left:none;width:48pt;text-align:center'>#numberformat(gettimesheet.ot4,'.__')#</td>
                    <td class=xl798828 width=64 style='border-top:none;border-left:none;width:48pt;text-align:center'>#numberformat(gettimesheet.ot5,'.__')#</td>
                    <td class=xl798828 width=64 style='border-top:none;border-left:none;width:48pt;text-align:center'>#numberformat(gettimesheet.ot6,'.__')#</td>
                    <td class=xl798828 width=64 style='border-top:none;border-left:none;width:48pt;text-align:center'>#numberformat(gettimesheet.ot7,'.__')#</td>
                    <td class=xl798828 width=64 style='border-top:none;border-left:none;width:48pt;text-align:center'>#numberformat(gettimesheet.ot8,'.__')#</td>

                    <cfset totalot1 = totalot1 + numberformat(gettimesheet.ot1,'.__')>
                    <cfset totalot2 = totalot2 + numberformat(gettimesheet.ot2,'.__')>
                    <cfset totalot3 = totalot3 + numberformat(gettimesheet.ot3,'.__')>
                    <cfset totalot4 = totalot4 + numberformat(gettimesheet.ot4,'.__')>
                    <cfset totalot5 = totalot5 + numberformat(gettimesheet.ot5,'.__')>
                    <cfset totalot6 = totalot6 + numberformat(gettimesheet.ot6,'.__')>
                    <cfset totalot7 = totalot7 + numberformat(gettimesheet.ot7,'.__')>
                    <cfset totalot8 = totalot8 + numberformat(gettimesheet.ot8,'.__')>

                    <td class=xl758828 style='border-top:none;border-left:none;word-wrap: break-word;white-space: normal' colspan="2">#gettimesheet.remarks#</td>
                    <td class=xl158828></td>
                    <td class=xl158828></td>
                </tr>
            </cfloop>
        ...
        <tr height=20 style='height:12.0pt'>
            ...
            <td class=xl808828 width=64 style='border-top:none;border-left:none;width:48pt;text-align:center'>#numberformat(totalhour,'.__')#</td>
            <td class=xl808828 width=64 style='border-top:none;border-left:none;width:48pt;text-align:center'>#numberformat(totalot1,'.__')#</td>
            <td class=xl808828 width=64 style='border-top:none;border-left:none;width:48pt;text-align:center'>#numberformat(totalot2,'.__')#</td>
            <td class=xl808828 width=64 style='border-top:none;border-left:none;width:48pt;text-align:center'>#numberformat(totalot3,'.__')#</td>
            <td class=xl808828 width=64 style='border-top:none;border-left:none;width:48pt;text-align:center'>#numberformat(totalot4,'.__')#</td>
            <td class=xl808828 width=64 style='border-top:none;border-left:none;width:48pt;text-align:center'>#numberformat(totalot5,'.__')#</td>
            <td class=xl808828 width=64 style='border-top:none;border-left:none;width:48pt;text-align:center'>#numberformat(totalot6,'.__')#</td>
            <td class=xl808828 width=64 style='border-top:none;border-left:none;width:48pt;text-align:center'>#numberformat(totalot7,'.__')#</td>
            <td class=xl808828 width=64 style='border-top:none;border-left:none;width:48pt;text-align:center'>#numberformat(totalot8,'.__')#</td>
            <td class=xl708828 width=157 style='border-top:none;border-left:none;width:118pt' colspan="2">&nbsp;</td>
            <td class=xl158828></td>
            <td class=xl158828></td>
        </tr>
        ...
        <cfquery name="getleavegroup" datasource="#dts#">
            SELECT stcol,sum(workhours) as totalwh FROM timesheet WHERE empno = <cfqueryparam cfsqltype="cf_sql_varchar" value="#getplacementlist.empno#"> 
            AND placementno = '#pno#'
        </cfquery>
        ...
        <cfquery name="getot" datasource="#dts#">
            SELECT sum(othour) as oth FROM timesheet WHERE empno = <cfqueryparam cfsqltype="cf_sql_varchar" value="#getplacementlist.empno#"> 
            AND placementno = '#pno#'
        </cfquery>
        ...
        <tr height=20 style='height:12.0pt'></tr>
            <tr>
    </table>
</div>

<div align=center>
    <input type="button" id="print_btn" value="Print" onClick="window.print();">
</div>
