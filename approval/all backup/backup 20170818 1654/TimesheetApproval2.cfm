...
<!---    <cfthread name="processPhoto" action="run">--->
    ...
    <CFIF IsImage(TheImage)>
         ...
         <cfset ImageWrite(TheImage, "#uploaddir#\#form.placementno#-#form.id#.png")>
         </cfoutput>
        <cfquery name="Approve" datasource="#dts#">
         ...
         signdoc = <cfqueryparam cfsqltype="cf_sql_varchar" value="/upload/#dts#/signature/timesheet/#form.placementno#-#form.id#.png">     
...
<!---    </cfthread>--->
    ...
    <cfquery name="checkid" datasource="#dts#">
     SELECT id FROM timesheet WHERE signdoc != '' and id = '#form.id#'
    </cfquery> 
...
<cfelse>
    ...
    <form method="post" action="timesheetapproval2.cfm" class="sigPad">
...
<!---    <div id="signimgdiv" style>
    ...
    <div class="sig sigWrapper">
        ...
        <button type="button" onClick="location.href='/approval/timesheetapprovalmain.cfm'">Back</button>
    </form>
