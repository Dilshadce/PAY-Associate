...
function confirmDecline(type,id,pno) {
	...
	if (answer){
		...
		window.location = "TimesheetApprovalProcess.cfm?type="+type+ "&id="+id+"&remarks="+remark_text+"&pno="+pno;
	}
	else{
...
<!---    <input type="text" hidden id="pno" name="pno" value="#getposlist.placementno#">
    ...
    <tr onMouseOut="javascript:this.style.backgroundColor='';" onMouseOver="javascript:this.style.backgroundColor='f3bd90';">
        ...
        <td valign="top"><textarea name="management_#getposlist.tmonth#_#getposlist.placementno#" id="management_#getposlist.tmonth#_#getposlist.placementno#" cols="15" rows="3"></textarea></td>
    ...
    --->
            ...
            <td valign="top">
                <a href="##" onclick="confirmApprove#apptype#('app','#getposlist.tmonth#','#getposlist.placementno#')"><img height="30px" width="30px" src="/images/1.png" alt="Approve" border="0"><br/>Approve</a>
            </td>
            <td valign="top">
                <a href="##" onclick="confirmDecline('dec','#getposlist.tmonth#','#getposlist.placementno#')"><img height="30px" width="30px" src="/images/2.png" alt="Decline" border="0"><br />Decline</a>
            </td>
...
<!---         <th width="6%"><center>Approval Doc</th> --->
	...
	<cfinput type="hidden" name="rows" id="rows" value="#getposlist.CurrentRow#">
	    ...
	    <tr onMouseOut="javascript:this.style.backgroundColor='';" onMouseOver="javascript:this.style.backgroundColor='f3bd90';">
            ...
            <td align="center">#monthasstring(getflday.tmonth)#</td>
