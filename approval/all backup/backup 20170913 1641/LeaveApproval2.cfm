...
<!---    <cfthread name="processPhoto" action="run">--->
    ...
    <CFIF IsImage(TheImage)>
        ...
        <cfquery name="Approve" datasource="#dts2#">
         ...
         signdoc = <cfqueryparam cfsqltype="cf_sql_varchar" value="/upload/#dts#/signature/leave/#form.id#.png">     
         WHERE id = #form.id#
        </cfquery> 
    </CFIF>
<!---    </cfthread>--->
    ...
    <cfquery name="checkid" datasource="#dts2#">
     SELECT id FROM leavelist WHERE signdoc != '' and id = '#form.id#'
    </cfquery> 
    ...
    <cfelse>
        ...
        <cfset template2 = getemail.template10>
        <cfset header2 = getemail.header10>
        ...
        SELECT empno,leavetype FROM leavelist a LEFT JOIN placement b on a.placementno = b.placementno WHERE id = '#form.id#'
        </cfquery>
...
<cfelse>
    ...
    <form method="post" action="leaveapproval2.cfm" class="sigPad">
...
<!---    <div id="signimgdiv" style>
    ...
    <div class="sig sigWrapper">
        ...
        <button type="button" onClick="location.href='/approval/leaveapprovalmain.cfm'">Back</button>
    </form>
