 		...
 		<!---edited---> 
            ...
            <cfelse>
                ...
                <cfquery name="updateTimesheet" datasource="#dts#">
                    ...
                    <cfif "#getleavetype.days#" EQ "0.50">
                        <cfif "#val(left(getleavetype.startampm, 2))#" LT 12>
                            starttime = '#numberformat(val(left(getleavetype.startampm, 2)), '__')+4#:#right(getleavetype.startampm, 2)#:00',
                            endtime = '#numberformat(val(left(getleavetype.endampm, 2)), '__')+4#:#right(getleavetype.endampm, 2)#:00',
                        <cfelse>
                            starttime = '#numberformat(val(left(getleavetype.startampm, 2)), '__')-4#:#right(getleavetype.startampm, 2)#:00',
                            endtime = '#numberformat(val(left(getleavetype.endampm, 2)), '__')-4#:#right(getleavetype.endampm, 2)#:00',
                        </cfif>
                    ...
                    <!---Added to set timesheet--->                  
                  	<cfif (#getleavetype.startampm# eq '00:00') AND (#getleavetype.endampm# eq '00:00')>
                        ampm = 'FULL DAY',
                    <cfelseif #val(left(getleavetype.startampm, 2))# gt 12>
                        ampm = 'PM',
                    <cfelseif #val(left(getleavetype.startampm, 2))# lt 12>
                        ampm = 'AM',
                    </cfif>
                    breaktime = '0',
