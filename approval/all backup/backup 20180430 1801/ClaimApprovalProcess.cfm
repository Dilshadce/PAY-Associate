...
<cfabort>
	...
	<cfelseif url.type eq "app">
        ...
        <cfset template = getemail2.template16>
        <cfset header = getemail2.header16>
        <cfset template2 = getemail2.template17>
        <cfset header2 = getemail2.header17>
        
         <cfquery name="getdata" datasource="#dts2#">
         SELECT a.*, b.*, c.*, CASE WHEN workemail = "" THEN email ELSE workemail END AS validemail FROM claimlist a 
        ...
        <cfif getempno.recordcount NEQ 0 and getdata.validemail neq "">
