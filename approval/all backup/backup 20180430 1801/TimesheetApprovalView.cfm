        ...
        <cfquery name="gettimesheet" datasource="#dts#">
            SELECT * FROM 
                (
                    ...
                    and pdate between <cfqueryparam cfsqltype="cf_sql_varchar" value="#datestart#"> and <cfqueryparam cfsqltype="cf_sql_varchar" value="#dateend#">  
                    ORDER BY pdate
                ) AS sort
                GROUP by pdate	
        </cfquery>
...
<table border=0 cellpadding=0 cellspacing=0 width=735 style='border-collapse:
 ...
 <col width=80 span=2 style='width:45pt'>
  <col width=70 span=2 style='width:40pt'>
 ...
 <tr height=21 style='mso-height-source:userset;height:15.75pt'>
  ...
  <td colspan=9 class=xl1248828 width=128 style='border-right:1pt solid black;
 ...
 <tr height=20 style='height:15.0pt'>
  ...
  <td colspan=9 class=xl1288828 width=128 style='border-left:none;width:96pt'><cfif "#emp_data.nricn#" NEQ "">#emp_data.nricn#<cfelse>#emp_data.passport#</cfif></td>
  <td><input type="hidden" name="enddate" id="enddate" value="<cfif gettimesheet.recordcount neq 0>#dateformat(gettimesheet.assigndate,'dd/mm/yyyy')#</cfif> " size="12" readonly><!--- <img src="/images/cal.gif" width=17 height=15 border=0 onClick="showCalendarControl(document.getElementById('enddate'));"> ---></td>
 </tr>
 <tr height=20 style='height:15.0pt'>
...
<tr height=20 style='height:15.0pt'>
 ...
 <cfset startcount = 1>
  ...
  <td class=xl768828 style='border-top:none;border-left:none'><cfif gettimesheet.stcol neq "">#gettimesheet.stcol#<cfelse>WD</cfif></td>  <td class=xl768828 style='border-top:none;border-left:none'>#gettimesheet.ampm#
        </td>
 ...
 <tr height=20 style='height:12.0pt'>
  ...
  <td class=xl808828 width=64 style='border-top:none;border-left:none;
  width:48pt'>#numberformat(totalot1,'.__')#</td>
  <td class=xl808828 width=64 style='border-top:none;border-left:none;
  width:48pt'>#numberformat(totalot2,'.__')#</td>
  <td class=xl808828 width=64 style='border-top:none;border-left:none;
  width:48pt'>#numberformat(totalot3,'.__')#</td>
  <td class=xl808828 width=64 style='border-top:none;border-left:none;
  width:48pt'>#numberformat(totalot4,'.__')#</td>
  <td class=xl808828 width=64 style='border-top:none;border-left:none;
  width:48pt'>#numberformat(totalot5,'.__')#</td>
  <td class=xl808828 width=64 style='border-top:none;border-left:none;
  width:48pt'>#numberformat(totalot6,'.__')#</td>
  <td class=xl808828 width=64 style='border-top:none;border-left:none;
  width:48pt'>#numberformat(totalot7,'.__')#</td>
  <td class=xl808828 width=64 style='border-top:none;border-left:none;
  width:48pt'>#numberformat(totalot8,'.__')#</td>
...
<!---  <tr height=20 style='height:12.0pt'>
 ...
 <!---  <td height=20 class=xl1188828 style='border-right:1pt solid black;
  ...
  <td class=xl1188828 colspan="2">Work <cfif getplacementlist.clienttype eq "hr">Hours<cfelse>Days</cfif></td>
