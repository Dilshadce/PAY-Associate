...
SELECT empno,hrmgr,verifier FROM placement WHERE placementno = <cfqueryparam cfsqltype="cf_sql_varchar" value="#form.pno#">
</cfquery>
<cfif getempno.hrmgr neq getHQstatus.entryid and getempno.verifier neq getHQstatus.entryid>
<cfabort>
</cfif>
</cfif>
...
SELECT * FROM placement WHERE placementno = '#form.pno#' <!---and startdate <= "#dateformat(currentdate,'yyyy-mm-dd')#" and completedate >= "#dateformat(currentdate,'yyyy-mm-dd')#"--->and jobstatus = 2
</cfquery>
